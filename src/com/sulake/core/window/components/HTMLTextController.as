package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_905:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_906:String = "default";
      
      private var var_1097:String = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1097 == param2)
         {
            return;
         }
         param1.var_1097 = param2;
         param1.var_1696 = null;
         if(param1.var_1097 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1097);
      ...
      {
         if(PropertyDefaults.const_892.indexOf(param1) > -1)
         {
            this.var_906 = param1;
         }
      }
      ...
      {
         return this.var_906 == LinkTarget.const_32 ? defaultLinkTarget : this.var_906;
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_786)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_906 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_888,this.var_906,PropertyStruct.const_56,true,PropertyDefaults.const_892));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_888)
            {
               this.var_906 = _loc2_.value as String;
               break;
            }
