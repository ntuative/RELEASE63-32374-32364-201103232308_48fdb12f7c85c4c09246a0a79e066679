package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1419:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1420:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2865 = new Array();
         this.var_160 = this.profiler;
         this._windowManager = param2;
         this.var_1007 = param3;
         var _loc4_:ByteArray = new var_1419() as ByteArray;
      ...
      {
         var _loc2_:ByteArray = new var_1420() as ByteArray;
