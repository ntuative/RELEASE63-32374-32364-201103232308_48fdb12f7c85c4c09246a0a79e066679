package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1328:uint = 13232628;
      
      private static var var_1589:uint = 11129827;
      ...
      private var var_1063:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1588 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_700)
         {
            this.var_700 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_700)
            {
               return;
            }
            this._window.content.addChild(this.var_700);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_699)
         {
            this.var_699 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_699)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_699.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_473;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_473);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_840:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_838:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_836:
               break;
            case ChangeUserNameResultMessageEvent.var_837:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_839:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1043 || param1 == ChangeUserNameResultMessageEvent.var_1042)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1063 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1063.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1328;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_473 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_473);
               break;
