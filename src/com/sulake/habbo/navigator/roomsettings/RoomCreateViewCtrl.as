package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1189:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_644 = new Timer(100);
         this.var_644.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_644)
         {
            this.var_644.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_644.reset();
            this.var_644 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1189.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1866 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1866 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_189 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_60 = IItemListWindow(this.var_189.findChildByName("item_list"));
         ...
         this.var_1188 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_189.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_189.desktop,this.var_189.width,this.var_189.height);
         this.var_189.x = _loc4_.x;
         this.var_189.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1188.goBackToInitialState();
         this.var_1188.input.textBackgroundColor = 4294967295;
         this.var_1189 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_62,HabboWindowStyle.const_32,HabboWindowParam.const_59,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1188.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_189.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_189.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1188.getText();
         var _loc3_:String = "model_" + this.var_1189.name;
