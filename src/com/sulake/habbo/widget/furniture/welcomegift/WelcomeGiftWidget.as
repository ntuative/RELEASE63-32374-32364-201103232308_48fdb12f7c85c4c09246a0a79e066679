package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_608:String = "welcome_gift_email_unverified";
      
      private const const_957:String = "welcome_gift_email_verified";
      
      private const const_1319:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1109)
         {
            this.setViewState(this.const_957);
         }
         else
         {
            this.setViewState(this.const_608);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_608:
               ...
               this.var_16.findChildByName("edit_text").visible = this.var_1725;
               this.var_16.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1725);
               break;
            case this.const_957:
      ...
      {
         this.setViewState(this.const_1319);
      }
      ...
      {
         this.setViewState(!!this.var_1109 ? this.const_957 : this.const_608);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1382 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1382));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_449,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_904,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_449,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_904,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_449:
               this.var_1383 = param1.email;
               this.var_1109 = param1.isVerified;
               this.var_1725 = param1.allowEmailChange;
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1382);
