package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_942:int = 60;
      
      private static const const_943:int = 3600;
      
      private static const const_944:int = 86400;
      
      private static const const_941:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_942) + " mins ago";
         }
         if(param1 < 2 * const_944)
         {
            return Math.round(param1 / const_943) + " hours ago";
         }
         if(param1 < 2 * const_941)
         {
            return Math.round(param1 / const_944) + " days ago";
         }
         return Math.round(param1 / const_941) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1167,this._data.userId),this._callerFrame,this.var_1075,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1075,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1401),this._callerFrame,this.var_1075,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1401),this._callerFrame,this.var_1075,false,true);
      }
