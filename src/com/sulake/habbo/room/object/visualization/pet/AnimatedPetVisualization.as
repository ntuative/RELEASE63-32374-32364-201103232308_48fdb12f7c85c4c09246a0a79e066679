package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1310:String = "head";
      
      private static const const_603:int = 1;
      
      private static const const_945:int = 1000;
      
      private static const const_1308:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1308) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_347 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2239)
            {
               this.var_2239 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_179)
         {
            ...
            this.var_1963 = _loc3_.getNumber(RoomObjectVariableEnum.const_340) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_205);
            if(!isNaN(_loc8_))
            {
               this.var_1633 = _loc8_;
            }
            else
            {
               this.var_1633 = direction;
            }
            this.var_1348 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2238 = _loc3_.getNumber(RoomObjectVariableEnum.const_895);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_742);
            if(_loc9_ != this.var_1632)
            {
               this.var_1632 = _loc9_;
               this.var_2240 = this.var_1632.toString();
            }
            var_179 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_347 != null)
         {
            ...
            if(this.var_1348 > 0)
            {
               _loc2_ = param1 - this.var_1348;
               if(_loc2_ < const_945)
               {
                  this.var_347.alpha = int(Math.sin(_loc2_ / const_945 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_347.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_347.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_279)
         {
            ...
            this.setAnimationForIndex(const_1307,_loc3_);
         }
         if(param2 != this.var_1459)
         {
            this.var_1459 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_103,param2);
            this.setAnimationForIndex(const_1309,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2240);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_603)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_501.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_501[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1633);
         }
         return direction;
      }
      ...
      {
         if(this.var_880[param1] == null)
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1310)
            {
               this.var_880[param1] = true;
            }
            else
            {
               this.var_880[param1] = false;
            }
         }
         return this.var_880[param1];
      }
   }
}
