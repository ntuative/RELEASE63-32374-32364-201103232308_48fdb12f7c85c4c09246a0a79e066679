package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_226:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_226 = this.var_629[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_226)
         {
            this.var_226.setAnimation(param1);
         }
      ...
      {
         if(this.var_226 && this.var_226.controlsSprite(param3))
         {
            return this.var_226.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1115);
         if(_loc3_.length == 0)
         {
