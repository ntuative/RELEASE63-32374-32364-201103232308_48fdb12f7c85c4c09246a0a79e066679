package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2820 = parseInt(param1.@precedence);
         this.var_2823 = String(param1.@activepartset);
         this.var_2821 = String(param1.@assetpartdefinition);
         this.var_2824 = String(param1.@lay);
         this.var_817 = String(param1.@geometrytype);
         this.var_2544 = Boolean(parseInt(param1.@main));
         this.var_2822 = Boolean(parseInt(param1.@name_4));
         this.var_2826 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "ParkBusCannotEnterMessageEvent"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2825 = _loc6_;
            }
            else
            {
               this.var_1850[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_835.add(param1,new Map());
         }
         var _loc4_:Map = this.var_835.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_835.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1850[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2825;
         }
         return _loc2_;
      }
      
      private function method_7(param1:String) : Array
      {
         if(param1 == "")
         {
            return [];
      ...
      {
         return this._prevents.concat(this.method_7(param1));
      }
