package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2026:String = "hd-99999-99999";
      ...
      private var var_709:PaletteManager;
      ...
      private var var_1619:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_595 = RenderMode.const_1448;
         ...
         this.var_104.add(AvatarType.const_113,_loc4_);
         ...
         this.var_104.add(AvatarType.const_68,_loc4_);
         ...
         this.var_709 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_295.init();
         this.var_709.init();
         _loc2_ = this.var_104.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_104.getValue(AvatarType.const_68) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_104.getValue(AvatarType.const_113) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_900)
         {
            if(this.var_2200 && this.var_2201 && this.var_2202)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_104.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1619)
         {
            this.var_1619 = new AvatarFigureContainer(this.const_2026);
         }
         this.var_219.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1619,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_296.getKeys())
         {
            _loc4_ = this.var_296.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1663)
         {
            _loc6_ = !this.var_295.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_295.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_104.getValue(AvatarType.const_68) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_296.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_104.getValue(AvatarType.const_68);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_296.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_296.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_104.getValue(AvatarType.const_113) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_68:
               _loc3_ = this.var_104.getValue(AvatarType.const_68) as AvatarStructure;
               break;
            default:
