package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1049:ITabSelectorWindow;
      
      protected var var_2081:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1049 = findChildByTag(const_1398) as ITabSelectorWindow;
            if(this.var_1049 != null)
            {
               this.var_1049.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2081 = findChildByTag(const_1397) as IWindowContainer;
         }
      ...
      {
         return !!this.var_829 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1049.numSelectables;
      }
