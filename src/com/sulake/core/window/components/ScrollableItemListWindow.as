package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_442:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_442)
         {
            this.var_442.removeEventListener(WindowEvent.const_296,this.scrollBarEventProc);
            this.var_442.removeEventListener(WindowEvent.const_258,this.scrollBarEventProc);
            this.var_442 = null;
         }
         if(this.var_1221)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1221)
         {
            this.var_1221 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_442)
         {
            this.var_442 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_442)
            {
               this.var_442.addEventListener(WindowEvent.const_296,this.scrollBarEventProc);
               this.var_442.addEventListener(WindowEvent.const_258,this.scrollBarEventProc);
            }
         }
         return this.var_442;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_258)
         {
            this.hideScrollBar();
         }
      }
