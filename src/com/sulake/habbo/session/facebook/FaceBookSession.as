package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_968:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1370:String = "sendAccessTokenToServer";
      
      private static const const_1371:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1370,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1371,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_968);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_968);
         }
      }
