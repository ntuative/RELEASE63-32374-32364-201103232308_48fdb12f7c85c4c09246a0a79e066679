package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      {
         if(this.var_16 == null || this.var_514 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in this.colors)
         {
            ...
            _loc3_.width = this.var_633.width;
            _loc3_.height = this.var_633.height;
            this.var_514.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_633.width,this.var_633.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_633,this.var_633.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1169.width,this.var_1169.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_962.width,this.var_962.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_962,this.var_962.rect,new Point(0,0),null,null,true);
