package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var var_237:ClubBuyConfirmationDialog;
      ...
      public function onOffers(param1:HabboClubOffersMessageEvent) : void
      {
         ...
         {
            _loc7_ = new ClubBuyOfferData(_loc5_.offerId,_loc5_.method_1,_loc5_.price,_loc5_.upgrade,_loc5_.vip,_loc5_.periods,_loc5_.daysLeftAfterPurchase,_loc5_.year,_loc5_.month,_loc5_.day);
      ...
      {
         this.closeConfirmation();
         this.var_237 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function getClubType() : int
      {
         ...
         {
            _loc1_ = !!this._catalog.getPurse().isVIP ? 0 : int(HabboClubLevelEnum.const_42);
         }
         return _loc1_;
      }
