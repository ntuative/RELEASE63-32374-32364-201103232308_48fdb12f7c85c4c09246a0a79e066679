package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1358:String = "room_view";
      
      private const const_2044:String = "room_widget";
      
      private var var_52:IWindowContainer;
      
      private var var_764:int = 50;
      
      private var var_2871:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_52.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_317,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(this.const_2044) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_52.getChildByTag(this.const_1358) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               ...
               _loc2_.width = this.var_52.desktop.width - this.var_764;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.height = this.var_52.desktop.height - this.var_764;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_52.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_52.findChildByTag(this.const_1358) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
