package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1635:int = 200;
      ...
      {
         this.var_711 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1642;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_881.pop() as IWindowContainer;
         }
