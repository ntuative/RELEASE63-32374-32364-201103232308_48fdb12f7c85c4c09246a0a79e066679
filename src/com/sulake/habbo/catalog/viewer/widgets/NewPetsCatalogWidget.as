package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1351:int = 18;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_211 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1351 && _loc2_ < this.var_211.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_509,this.var_211[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_211 != null && this.var_211.length > 0)
         {
            ...
            this.var_364 = this.var_211[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_509,this.var_364),this.getRaceLocalizationKey(this.var_509,this.var_364));
            }
         }
         return this.getRaceLocalizationKey(this.var_509,this.var_364);
      }
