package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1650:int = 13421772;
      
      private static const const_1009:int = 16777215;
      
      private static const const_1012:int = 13421772;
      
      private static const const_1010:int = 10066329;
      
      private static const const_1011:int = 10066329;
      
      public static const const_1667:int = 16777215;
      
      public static const const_1451:int = 13421772;
      
      public static const const_1571:int = 10066329;
      ...
      private var var_827:Rectangle = null;
      
      private var var_549:RoomPlaneBitmapMaskParser = null;
      
      private var var_1603:String = null;
      
      private var _floorType:String = null;
      
      private var var_1604:String = null;
      
      private var var_2779:String = null;
      
      private var var_1270:uint = 16777215;
      
      private var var_2780:int = 255;
      
      private var var_2781:int = 255;
      
      private var var_2782:int = 255;
      
      private var var_1997:Boolean = true;
      
      private var var_1891:int = 0;
      
      private var var_1621:int = -1000;
      
      private const const_2073:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_549 = new RoomPlaneBitmapMaskParser();
         this.var_326["null"] = false;
         this.var_326["null"] = true;
         this.var_326["null"] = true;
         this.var_326["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_827 = super.boundingRectangle;
         }
         return new Rectangle(this.var_827.x,this.var_827.y,this.var_827.width,this.var_827.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1098);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1195);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_319)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1516)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_119,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_319)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         _loc9_ = param2;
         if(_loc9_ < this.var_1621 + this.const_2073 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_390.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1997)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2782 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2781 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2780 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1592)
         {
            this.var_1592 = param1.updateId;
            this.var_827 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1329 || _loc3_.y != this.var_2131 || _loc3_.z != this.var_2132 || param1.scale != this.var_2134))
            {
               this.var_1329 = _loc3_.x;
               this.var_2131 = _loc3_.y;
               this.var_2132 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_179 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1117);
            if(_loc3_ != this.var_2779)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2779 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_716));
            if(_loc4_ != this.var_1270)
            {
               this.var_1270 = _loc4_;
               this.var_2782 = this.var_1270 & 255;
               this.var_2781 = this.var_1270 >> 8 & 255;
               this.var_2780 = this.var_1270 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1225));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_179 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_901);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_727);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_674);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_687));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_849));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_648));
      ...
      {
         if(param1 != this.var_326["null"] || param2 != this.var_326["null"] || param3 != this.var_326["null"])
         {
            this.var_326["null"] = param1;
            this.var_326["null"] = param2;
            this.var_326["null"] = param3;
            this.var_390 = [];
            this.var_679 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_326[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1891;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_549.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_549.maskCount)
         {
            _loc10_ = this.var_549.getMaskType(_loc8_);
            _loc11_ = this.var_549.getMaskLocation(_loc8_);
            _loc12_ = this.var_549.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_139.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_119 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_119 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_241)
                              {
