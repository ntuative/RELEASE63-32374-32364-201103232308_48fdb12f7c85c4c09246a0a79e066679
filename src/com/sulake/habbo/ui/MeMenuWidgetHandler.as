   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_277,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_841,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_763,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_188 != null)
            {
               this.var_188.events.removeEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_595,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_277,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_841,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_763,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_595,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1455)
            {
               ...
               this.var_1455 = _loc2_;
               this.var_1854 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1854;
            }
         }
         if(this.var_188 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1199,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_833);
         _loc1_.push(RoomWidgetDanceMessage.const_688);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_664);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_874);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_690);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_774);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_743);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_375);
         _loc1_.push(RoomWidgetStopEffectMessage.const_820);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1671);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1047);
         _loc1_.push(RoomWidgetToolbarMessage.const_672);
         _loc1_.push(RoomWidgetToolbarMessage.const_857);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_402);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1452);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1016);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_883);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_866);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_746);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1605);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_889);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_825);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_871);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_408);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_866:
               ...
               break;
            case RoomWidgetWaveMessage.const_833:
            ...
            case RoomWidgetDanceMessage.const_688:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_664:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_874:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_690:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_375:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1198)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_200,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_743:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1246:
                        this._catalog.openCatalogPage(CatalogPageName.const_1688,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1130:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1683:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1702:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_820:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1220:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1617:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1047:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_883:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_672:
               ...
               if(this.var_188)
               {
                  this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                     if(this._container != null && this._container.sessionDataManager != null)
                     {
                        _loc12_ = this._container.sessionDataManager.hasUserRight("fuse_use_club_dance",HabboClubLevelEnum.const_42);
                     }
            ...
            case RoomWidgetToolbarMessage.const_857:
               ...
               {
                  this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_493,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_402:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_435));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_746:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_341,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_889:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_341,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_825:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_341,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_871:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_455));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_408:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_790));
      }
