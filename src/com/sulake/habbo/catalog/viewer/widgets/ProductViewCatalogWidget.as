package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1971:Point;
      
      private var var_544:IItemGridWindow;
      
      private var var_1530:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1029 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1256 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1971 = new Point(this.var_88.x,this.var_88.y);
         this.var_544 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1530 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1970 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1029.text = _loc4_;
         this.var_1256.text = _loc5_;
         this.var_1029.height = this.var_1029.textHeight + 5;
         this.var_1256.y = this.var_1029.y + this.var_1029.height;
         this.var_1256.height = Math.max(130,this.var_1256.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_509:
                  _loc6_ = this.var_1970.clone();
                  if(this.var_544 != null)
                  {
                     this.var_544.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_544,this.var_1530,this.var_1807);
                     this.var_544.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_181:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_307,AvatarAction.const_480);
                              _loc16_.appendAction(AvatarAction.const_294,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2745)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_88 != null && true)
         {
            ...
            this.var_88.x = this.var_1971.x;
            this.var_88.y = this.var_1971.y;
            if(param3 != null)
            {
