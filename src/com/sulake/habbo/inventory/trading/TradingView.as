package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_932:uint = 4284532064;
      
      private static const const_933:uint = 2577770;
      ...
      private var var_406:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_406 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_199)
            {
               this.var_199.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_199.stop();
               this.var_199 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1587 = this.createMinimizedWindow();
         }
         if(!this.var_2128)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_932) : uint(const_933);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_932) : uint(const_933);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_199 = new Timer(1000,3);
            this.var_199.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_199.reset();
         this.var_199.repeatCount = 3;
         this.var_199.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_199.currentCount));
         if(this.var_199.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1211)
            {
            ...
            this.var_406.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_433);
            this.var_406.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_406.hideDelayed();
         }
      }
