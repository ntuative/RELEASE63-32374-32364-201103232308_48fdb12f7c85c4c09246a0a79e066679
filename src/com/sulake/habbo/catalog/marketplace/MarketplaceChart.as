package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_638)
            {
               this.var_638 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_638).toString().length - 1);
         this.var_638 = Math.ceil(this.var_638 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_638.toString();
         _loc3_.draw(_loc6_);
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1178,(param2 - this.var_969) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1178 + this.var_1178 / -this.var_2872 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_969 - this.var_969 / this.var_638 * this.var_163[param1];
      }
