package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1315:String = "shore";
      ...
      {
         if(this.var_2295 == param1 && this.var_2296 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1315)
            {
               this.var_1671 = _loc2_;
               this.var_2295 = param1;
               this.var_2296 = direction;
               return this.var_1671;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1085.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_488 + 2;
         var _loc4_:int = this.var_585 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1672 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_420.length)
         {
            if(this.var_420[_loc5_] == true)
            {
               this.var_1672 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_586[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_586[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_488 == 0 || this.var_585 == 0)
         {
            ...
            this.var_488 = _loc2_.getNumber(RoomObjectVariableEnum.const_323);
            this.var_585 = _loc2_.getNumber(RoomObjectVariableEnum.const_366);
         }
         this.var_420 = [];
         this.var_586 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_488 * 2 + this.var_585 * 2)
         {
            this.var_420.push(false);
            this.var_586.push(ShoreMaskCreatorUtility.const_80);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_488 + 2;
         var _loc2_:int = this.var_585 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_72,getSize(param3),this.var_420,this.var_586,assetCollection);
      }
