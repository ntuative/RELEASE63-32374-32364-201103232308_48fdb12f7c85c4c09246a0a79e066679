package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_741,RoomWidgetEcotronBoxOpenMessage.const_816,RoomWidgetEcotronBoxOpenedMessage.const_1539];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_741:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_816:
