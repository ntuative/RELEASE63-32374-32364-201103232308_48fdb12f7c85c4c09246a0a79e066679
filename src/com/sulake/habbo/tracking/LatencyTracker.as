package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1803 = int(this.var_195.getKey("latencytest.interval"));
         this.var_1802 = int(this.var_195.getKey("latencytest.report.index"));
         this.var_2513 = int(this.var_195.getKey("latencytest.report.delta"));
      ...
      private function testLatency() : void
      {
         ...
         this.var_626.add(this.var_1422,this.var_1801);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1422));
         ++this.var_1422;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_626 == null || this.var_225 == null)
         {
            return;
         }
         ...
         if(this.var_225.length == this.var_1802 && this.var_1802 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1800) > this.var_2513 || this.var_1800 == 0)
            {
