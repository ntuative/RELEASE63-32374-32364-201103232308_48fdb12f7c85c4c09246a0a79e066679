package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_453:IRoomSettingsCtrlOwner;
      ...
      private var var_1228:TextFieldManager;
      ...
      private var var_657:ICheckBoxWindow;
      ...
      private var var_1231:IWindowContainer;
      ...
      private var var_2679:ITextWindow;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1924 = true;
         this.var_453.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_381 || this.var_1235 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1235 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1565)
         {
            this.var_798.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1561)
         {
            this.var_798.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1690)
         {
            this.var_1233.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1656)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1570)
         {
            this.var_1003.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_798.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_880,this.onDoorModePasswordUnselect);
         ...
         this.var_798 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1233 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_982 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_981 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1003 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1228 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1229 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1234 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1230 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_657 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1925 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1501 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1227 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1231 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1923 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1500 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_274 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1232 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2680 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2679 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1499 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1499.mouseThreshold = 0;
         this.var_1499.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1232.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1925.visible = this._inRoom;
         this.var_1923.visible = this._inRoom;
         this.var_2679.visible = this.var_540;
         this.var_2680.visible = !this.var_540;
         if(this.var_540)
         {
            this.var_1231.visible = true;
            this.var_1500.visible = false;
            this.refreshFlatControllers();
            this.var_1231.height = Util.getLowestPoint(this.var_1231) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1501.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1501.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1227.height = Util.getLowestPoint(this.var_1227) + 4;
         }
         this.var_1499.text = !!this.var_540 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1925.name,this.var_1501.name,this.var_1227.name,this.var_1231.name,this.var_1500.name,this.var_1923.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_798.setText(_loc1_.name);
         this.var_1233.setText(_loc1_.description);
         this.var_1003.setText("");
         this.var_1228.setText("");
         ...
         this.setTag(this.var_982,_loc1_.tags[0]);
         this.setTag(this.var_981,_loc1_.tags[1]);
         if(this.var_1229)
         {
            if(_loc1_.allowPets)
            {
               this.var_1229.select();
            }
            else
            {
               this.var_1229.unselect();
            }
         }
         if(this.var_1234)
         {
            ...
            {
               this.var_1234.select();
            }
            else
            {
               this.var_1234.unselect();
            }
         }
         if(this.var_1230)
         {
         ...
         if(this.var_657)
         {
            ...
            {
               this.var_657.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_657.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_798.getText();
         _loc2_.description = this.var_1233.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_580;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_110)
         {
            _loc8_ = this.var_1003.getText();
            _loc9_ = this.var_1228.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1003.clearErrors();
               this.var_1228.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1229.isSelected;
         _loc2_.allowFoodConsume = this.var_1234.isSelected;
         _loc2_.allowWalkThrough = this.var_1230.isSelected;
         _loc2_.hideWalls = this.var_657.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_982,_loc2_.tags);
         this.addTag(this.var_981,_loc2_.tags);
         this.clearErrors();
         this.var_1235 = _loc2_.roomId;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         if(this._navigator.data.guestRoomSearchResults != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(this._navigator.tabs.getSelected().id,_loc3_.searchType,_loc3_.method_2);
         }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_274.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_274.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_274.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_274.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_274.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_274.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_274.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_274);
         this.var_274.findChildByName("ruler").visible = true;
         ...
         if(this.var_78.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_274,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_62,HabboWindowStyle.const_32,HabboWindowParam.const_59,new Rectangle(0,0,100,20)));
      }
