package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_844:int = 0;
      
      protected var var_684:BitmapData;
      
      protected var var_2523:int;
      
      protected var var_1561:Boolean;
      
      protected var var_2070:Boolean;
      
      protected var var_2839:BitmapData;
      
      private const const_2024:int = 8947848;
      
      private const const_2025:int = 13421772;
      
      private const const_1755:Number = 1;
      
      private const const_1754:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1333 = this._window.findChildByTag("BG_COLOR");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2840 == FurniModel.const_45)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1389));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2071);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_812)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1754;
               _loc1_.blend = this.const_1754;
            }
            else
            {
               this._window.blend = this.const_1755;
               _loc1_.blend = this.const_1755;
            }
         }
         if(this.isSelected)
         {
            this.var_1333.color = this.const_2024;
         }
         else
         {
            this.var_1333.color = this.const_2025;
         }
         ...
         if(_loc5_)
         {
            if(this.var_2070 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2839;
               _loc5_.visible = true;
            }
            else
            {
