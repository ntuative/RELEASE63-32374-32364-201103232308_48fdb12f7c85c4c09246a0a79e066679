package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_45:String = "S";
      
      public static const const_51:String = "I";
      
      public static const const_411:String = "pets";
      
      private static const const_1326:int = 100;
      ...
      private var var_1771:Vector.<Array>;
      
      private var var_1772:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_512 = param8;
         this.var_618 = new Timer(const_1326,1);
         ...
         this.var_2443 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_16 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_512);
         this.var_16.switchCategory(const_45);
      }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_45)
            {
               ...
               {
                  this.var_1771 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1771;
            }
            else
            {
               if(this.var_1772 == null)
               {
                  this.var_1772 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1772;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_79);
         ...
         this.var_16.setGridLock(param1,true);
         ...
         this.var_16.setGridLock(param1,false);
         this.updateItemLocks();
         if(this.getSelectedItemIndex(FurniModel.const_45) == -1)
         {
            this.toggleItemSelection(FurniModel.const_45,0);
         }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_386)
         {
         ...
         else if(param3 == FurniCategory.const_362)
         {
         ...
         else if(param3 == FurniCategory.const_398)
         {
         ...
         if(this.var_927 == null)
         {
            this.var_927 = this._windowManager.buildFromXML(this.var_2443) as IWindowContainer;
         }
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_45,const_51];
         var _loc5_:int = 0;
         ...
         if(param1 == InventoryCategory.const_79 && this._controller.isVisible)
         {
            switch(this.var_16.visibleCategoryId)
            {
               ...
               case const_51:
                  ...
                  break;
               case const_411:
                  this._controller.toggleInventoryPage(InventoryCategory.const_151);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_356);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_45,const_51];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_45,const_51];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_617.add(const_45,new Array());
         this.var_617.add(const_51,new Array());
         if(this.var_16 != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_314;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_362 || _loc3_.category == FurniCategory.const_386 || _loc3_.category == FurniCategory.const_398)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_617.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_617.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_812)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
