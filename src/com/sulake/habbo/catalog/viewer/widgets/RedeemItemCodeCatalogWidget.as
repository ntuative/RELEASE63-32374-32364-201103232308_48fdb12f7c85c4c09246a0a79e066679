package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_935.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_935 = null;
         }
         if(this.var_934 != null)
         {
            this.var_934.removeEventListener(WindowKeyboardEvent.const_198,this.windowKeyEventProcessor);
            this.var_934 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_935 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_935 != null)
         {
            this.var_935.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_934 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_934 != null)
         {
            this.var_934.addEventListener(WindowKeyboardEvent.const_198,this.windowKeyEventProcessor);
         }
         return true;
      }
