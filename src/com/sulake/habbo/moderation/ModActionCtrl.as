package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1126:IDropMenuWindow;
      
      private var var_501:ITextFieldWindow;
      
      private var _disposed:Boolean;
      
      private var var_678:Boolean = true;
      
      private var var_923:OffenceCategoryData;
      
      private var var_922:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1128 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1127 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1686;
         ...
         this.var_501 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_501.procedure = this.onInputClick;
         this.var_1126 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1126);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_923 != null;
         if(this.var_922 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_922.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_923 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_923.offences,this.var_1128,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1127,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1587;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1402,this.var_501.text,this.var_1401));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_923 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_922 = this.var_923.offences[_loc3_];
         this.var_501.text = this.var_922.msg;
         this.var_678 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1402,this.var_501.text,this.var_1401));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1126.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1402,this.var_501.text,this.getBanLength(),this.var_1401));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_678 || this.var_501.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1126.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1128.destroy();
            this.var_1128 = null;
         }
         if(this.var_1127 != null)
         {
            this.var_1127.destroy();
            this.var_1127 = null;
         }
         this.var_1126 = null;
         this.var_501 = null;
