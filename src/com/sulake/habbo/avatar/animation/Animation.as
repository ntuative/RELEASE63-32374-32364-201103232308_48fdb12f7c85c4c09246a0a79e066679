package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1951:AvatarDataContainer;
      
      private var var_1516:Array;
      
      private var var_1952:DirectionDataContainer;
      
      private var var_1950:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         if(param2.hasOwnProperty("sprite"))
         {
            ...
            {
               this.var_1517.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1951 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1516.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1952 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1950 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1518.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_816.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("HabboConfigurationCom_manifest"))
         {
            this._overrideFrames = new Map();
            this.var_665 = new Map();
            for each(_loc7_ in param2.HabboConfigurationCom_manifest)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@HabboConfigurationCom_manifest;
               this.var_665.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc9_ in _loc7_.fx)
            {
               ...
               _loc11_ = new AnimationLayerData(param3,_loc9_,AnimationLayerData.const_572,_loc6_,_loc5_);
               _loc4_.push(_loc11_);
               if(_loc5_ != null)
               {
               }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_665.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param2))
         {
            ...
            else if(_loc4_.type == AnimationLayerData.const_572)
            {
               for each(_loc5_ in this.var_816)
               {
      ...
      public function getLayerData(param1:int, param2:String, param3:String = null) : AnimationLayerData
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param3))
         {
            ...
            if(_loc4_.type == AnimationLayerData.const_572)
            {
               for each(_loc5_ in this.var_816)
               {
