package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1371:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_305.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      {
         this.var_16 = new ToolbarView(this._windowManager,this._assetLibrary,this.var_305.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "ParkBusCannotEnterMessageEvent")
         {
            this.var_1371 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_16 == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_153,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1199,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_138,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_91,this.onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_55,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_493,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1182,this.onDisplayWindowEvent);
