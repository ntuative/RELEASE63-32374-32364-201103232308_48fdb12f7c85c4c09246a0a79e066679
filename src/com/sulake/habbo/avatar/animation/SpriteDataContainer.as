package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2104:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2106 = String(param2.@member);
         this.var_2105 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1323 = [];
         this.var_1324 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1323[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1324[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1323.length)
         {
            return this.var_1323[param1];
         }
         return 0;
      }
      ...
      {
         if(param1 < this.var_1324.length)
         {
