package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2030:int = 10;
      ...
      private const const_1775:uint = 4.293848814E9;
      
      private const const_1776:uint = 4.294967295E9;
      
      private const const_2029:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_715 = _loc1_.boxTypes;
            this.var_714 = _loc1_.ribbonTypes;
            this.var_1094 = this.var_1690[0];
            this.var_352 = this.var_715[0];
            this.var_353 = this.var_714[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_353 < 0)
         {
            this.var_353 = this.var_714.length - 1;
         }
         if(this.var_353 > this.var_714.length - 1)
         {
            this.var_353 = 0;
         }
         if(this.var_352 < 0)
         {
            this.var_352 = this.var_715.length - 1;
         }
         if(this.var_352 > this.var_715.length - 1)
         {
            this.var_352 = 0;
         }
         var _loc1_:int = this.var_715[this.var_352] * 1000 + this.var_714[this.var_353];
         if(this._window == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_715[this.var_352]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_714[this.var_353]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_93,this.var_1369,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_93.offerId,this.var_1369);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_103:
               ...
               if(this.var_2315 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_236)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_2030)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2315 = _loc3_.text;
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN:
               ...
               break;
            case WindowKeyboardEvent.const_355:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_591 == null)
         {
            this.var_591 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_591.procedure = this.suggestionsEventHandler;
         }
         if(this.var_254 == null || this.var_591 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_591.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2029;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1775) : uint(this.const_1776);
      }
