package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_1269:Dictionary;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_60 = IItemListWindow(this.var_16.getChildByName("achievements_itemlist"));
         this.var_461 = new Timer(1000,1);
         this.var_461.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_321.events.addEventListener(BadgeImageReadyEvent.const_140,this.onBadgeImageReady);
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_1269[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1269[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_321.getBadgeImage(param2.badgeId);
            this.var_1269[param2.badgeId] = _loc4_;
         }
