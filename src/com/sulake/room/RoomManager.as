package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_658:int = -1;
      ...
      private var var_2909:IRoomContentLoader;
      
      private var var_623:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_622 = [];
         this.var_600 = [];
         events.addEventListener(RoomContentLoadedEvent.const_372,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_466,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_651,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_120.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_120.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_623 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_623 == null || this.var_506 == null)
         {
            return;
         }
         this._state = const_1471;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_622.indexOf(_loc5_) < 0)
            {
               this.var_57.loadObjectContent(_loc5_,events);
               this.var_622.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1081;
         return true;
      }
      ...
      public function addObjectUpdateCategory(param1:int) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_120.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         this.var_120.add(String(param1),_loc3_);
      ...
      {
         return this.var_120.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_120.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_623.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_623 != null)
         {
            return this.var_623.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_658)
         {
            return;
         }
         if(this.var_57 == null)
         {
            this._state = const_658;
            return;
         }
         if(this.var_57.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_622.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_937.length > 0)
         {
            _loc2_ = this.var_937[0];
            this.var_937.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_57 == null || this.var_506 == null)
         {
            return;
         }
         ...
         var _loc8_:int = this.var_120.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_120.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_120.getKey(_loc8_);
            if(_loc9_ != null)
            {
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_623.createRoomObjectLogic(_loc6_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:int = this.var_120.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_120.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
