package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1744:Number = 1.0;
      
      private var var_1743:Number = 1.0;
      
      private var var_1745:Number = 1.0;
      ...
      {
         super();
         this.var_1967 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2734 = parseInt(_loc2_,16);
         this.var_2736 = parseInt(_loc3_,16);
         ...
         this.var_926 = new ColorTransform(this.var_1744,this.var_1743,this.var_1745,this._alphaMultiplier);
         this.var_1254 = this.generatePaletteMapForGrayscale(this.var_2736,this.var_2734);
      }
      ...
      {
         return this.var_1254.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1254.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1254.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1254.getValue("alphas") as Array;
      }
