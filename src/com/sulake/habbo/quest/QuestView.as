package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private function createView() : void
      {
         switch(this.var_64.type)
         {
            ...
            case QuestTypeEnum.SWITCH_ITEM_STATE:
               this.var_16 = this.var_63.controller.questEngine.getXmlWindow("QuestTypeBasic");
               this.var_2091 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this.var_16)
               {
                  throw new Error("[QuestView] Could not create view for quest type: " + this.var_64.type + " !");
               }
               this.var_16.addEventListener(WindowEvent.const_47,this.onResized);
               return;
               break;
            default:
               throw new Error("[QuestView] View not defined for quest type: " + this.var_64.type + " !");
         }
      }
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_64)
         {
            this.var_63.controller.activateQuest(this.var_64);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc38_:* = null;
         var _loc39_:* = null;
         var _loc1_:String = ["quest",this.var_63.code,this.var_64.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_63.code,"type_" + this.var_64.type.toLowerCase()].join(".");
         ...
         if(this.var_64.type == QuestTypeEnum.FIND_STUFF)
         {
            _loc34_ = this.var_64.roomItemTypeName.split("*");
         ...
         else if(this.var_64.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            this.var_63.controller.questEngine.setImageFromAsset(_loc15_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else if(this.var_64.type == QuestTypeEnum.GIVE_BADGE)
         {
            this.var_63.controller.questEngine.setImageFromAsset(_loc15_,this.var_64.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else if(this.var_64.type == QuestTypeEnum.PLACE_ITEM)
         {
            this.var_567 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_64.type == QuestTypeEnum.PICKUP_ITEM)
         {
            this.var_567 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_64.type == QuestTypeEnum.ROTATE_ITEM)
         {
            this.var_567 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_64.type == QuestTypeEnum.MOVE_ITEM)
         {
            this.var_567 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_64.type == QuestTypeEnum.SWITCH_ITEM_STATE)
         {
            this.var_567 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         ...
         this.var_63.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_64.rewardCurrencyAmount.toString());
         this.setText("quest.reward.title",_loc13_);
         this.setText("quest.reward.desc",_loc14_,true,true);
         var _loc20_:int = this.var_64.endDate.date;
         var _loc21_:int = this.var_64.endDate.month + 1;
         var _loc22_:int = this.var_64.endDate.fullYear;
         var _loc23_:int = this.var_64.endDate.minutes;
         var _loc24_:int = this.var_64.endDate.hours;
         ...
         var _loc32_:String = "icon_" + this.var_63.code + "_reward_" + this.var_64.rewardCurrencyAmount;
         ...
         if(_loc33_)
         {
            this.var_566 = new Timer(20,1);
            this.var_566.addEventListener(TimerEvent.TIMER,this.onShowReward);
            this.var_566.start();
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_786;
            }
         }
      }
