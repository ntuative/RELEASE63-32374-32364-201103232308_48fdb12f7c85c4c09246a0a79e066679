package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_915:Array = [];
      
      private static var var_1720:int = 1000;
      
      private static var var_914:Array = [];
      
      private static var var_1718:int = 200;
      ...
      private var var_1717:IMessageComposer;
      ...
      {
         this.var_723 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_722 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_1717);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_915.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_914.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_723.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_914.length < var_1718)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_723.width;
            param1.height = this.var_723.height;
            var_914.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1719[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1380.getValue(param2.chatterName))
            {
               this.var_1380.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1380.getValue(_loc2_);
