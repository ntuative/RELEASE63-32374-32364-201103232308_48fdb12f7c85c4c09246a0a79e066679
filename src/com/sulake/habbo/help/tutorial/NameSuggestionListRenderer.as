package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_2063:int = 5;
      
      private const const_2064:int = 5;
      ...
      private var var_1218:Rectangle = null;
      ...
      public function render(param1:Array, param2:IWindowContainer) : int
      {
         ...
         this._offsetX = 0;
         this.var_1219 = 0;
         this.var_1218 = param2.rectangle.clone();
         this.var_1218.height = 150;
         var _loc4_:int = 0;
      ...
      {
         if(param1.width > this.var_1218.width)
         {
            return false;
         }
         if(this.var_1219 + param1.height > this.var_1218.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1218.width)
         {
            this._offsetX = 0;
            this.var_1219 += param1.height + this.const_2064;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1219);
         this._offsetX += param1.width + this.const_2063;
         return true;
      }
