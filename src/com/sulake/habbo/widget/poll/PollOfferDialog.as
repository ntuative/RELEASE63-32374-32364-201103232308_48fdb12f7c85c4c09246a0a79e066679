package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1455:String = "POLL_OFFER_STATE_OK";
      
      public static const const_747:String = "POLL_OFFER_STATE_CANCEL";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     this._state = const_1455;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_796,this._id));
                     break;
                  case "poll_offer_button_cancel":
                     this._state = const_747;
