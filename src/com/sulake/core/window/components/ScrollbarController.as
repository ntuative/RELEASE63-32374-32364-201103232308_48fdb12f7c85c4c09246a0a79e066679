package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1263:String = "increment";
      
      private static const const_1264:String = "decrement";
      
      private static const const_928:String = "slider_track";
      ...
      protected var var_683:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_178 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_463;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_18.removeEventListener(WindowEvent.const_47,this.onScrollableResized);
            this.var_18.removeEventListener(WindowEvent.const_558,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_47,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_558,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_860 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_928) as WindowController;
      }
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_304)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_683;
                  }
                  else
                  {
                     this.scrollV -= this.var_683;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN || param1.type == WindowTouchEvent.const_522)
         {
            ...
            else if(param2.name == const_1264)
            {
               if(this.var_18)
               {
                  this.var_1062 = true;
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_860) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_860) as IScrollableWindow;
               if(_loc1_)
               {
