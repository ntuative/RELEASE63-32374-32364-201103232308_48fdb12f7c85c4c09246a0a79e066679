package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1399:int = 11;
      
      private static const const_620:int = 18;
      
      private static const const_984:int = 16;
      
      private static const const_1400:int = 20;
      ...
      private var var_309:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1222 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2669 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_376 = new Timer(1000,1);
         this.var_376.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_443 = new Timer(10000,1);
         this.var_443.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_376.reset();
            this.var_376.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_376 = null;
         }
         if(this.var_443 != null)
         {
            this.var_443.reset();
            this.var_443.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_443 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_401,this.onWindowMoved);
         this.var_1909 = true;
         this.var_532 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_620 + const_984;
         _loc1_.x = const_620;
         _loc1_.y = const_1399;
      }
      ...
      {
         this.var_309 = param1 - (const_620 + const_984);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1222 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_532 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1400);
      }
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_309)
         {
