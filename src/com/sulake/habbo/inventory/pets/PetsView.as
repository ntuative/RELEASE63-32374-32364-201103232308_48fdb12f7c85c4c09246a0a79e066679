package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_16 = this._windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         if(this.var_16 == null)
         {
            return;
         }
         ...
         this.var_257 = this.var_16.findChildByName("grid") as IItemGridWindow;
         var _loc8_:IBitmapWrapperWindow = this.var_16.findChildByName("download_image") as IBitmapWrapperWindow;
         ...
         _loc8_ = this.var_16.findChildByName("image") as IBitmapWrapperWindow;
         _loc8_.bitmap = new BitmapData(_loc8_.width,_loc8_.height);
         ...
         _loc11_ = this.var_16.findChildByName("place_button") as IButtonWindow;
         if(_loc11_ != null)
         {
            _loc11_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.placeButtonClickHandler);
         }
         _loc11_ = this.var_16.findChildByName("open_catalog_btn") as IButtonWindow;
         if(_loc11_ != null)
         {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_61)
         {
            ...
            {
               case "tab_floor":
                  this.var_68.switchCategory(FurniModel.const_45);
                  break;
               case "tab_wall":
      ...
      private function selectPetsTab() : void
      {
         ...
         var _loc1_:ISelectorWindow = this.var_16.findChildByName("category_selector") as ISelectorWindow;
         if(_loc1_ != null)
         {
      ...
      public function setViewToState() : void
      {
         ...
         var _loc5_:IWindowContainer = this.var_16.findChildByName("grid_container") as IWindowContainer;
         var _loc6_:IWindowContainer = this.var_16.findChildByName("preview_container") as IWindowContainer;
         switch(_loc2_)
         {
            case this.const_986:
               _loc3_.visible = true;
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_16.findChildByName("preview_image") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         _loc2_.dispose();
         var _loc7_:ITextWindow = this.var_16.findChildByName("preview_text") as ITextWindow;
         if(_loc7_ != null)
         {
            _loc7_.caption = _loc3_;
         }
         _loc7_ = this.var_16.findChildByName("preview_description") as ITextWindow;
         if(_loc7_ != null)
         {
         ...
         _loc7_ = this.var_16.findChildByName("preview_info") as ITextWindow;
         if(_loc7_ != null)
         {
            _loc7_.caption = _loc10_;
         }
         var _loc11_:IButtonWindow = this.var_16.findChildByName("place_button") as IButtonWindow;
         if(_loc11_ != null)
         {
