package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_206:IBorderWindow;
      ...
      private const const_2047:int = 152;
      
      private const const_2054:int = 16;
      
      private const const_1361:int = 4;
      
      private const const_2053:uint = 14342874;
      
      private const const_2056:uint = 3815994;
      
      private const const_2046:uint = 2085362;
      
      private const const_2051:uint = 39616;
      
      private const const_2045:uint = 10513106;
      
      private const const_2052:uint = 8734654;
      
      private const const_2048:uint = 9094430;
      
      private const const_2050:uint = 6200576;
      
      private const const_2055:String = "happiness";
      
      private const const_2049:String = "experience";
      
      private const const_2057:String = "energy";
      ...
      {
         if(this.var_54 == null || this.var_206 == null || this.var_69 == null)
         {
            return;
         }
         this.var_69.width = this.var_69.scrollableRegion.width;
         this.var_69.visible = this.var_69.width > 0;
         this.var_54.height = this.var_54.scrollableRegion.height;
         this.var_206.height = this.var_54.height + 20;
         this._window.width = Math.max(this.var_206.width,this.var_69.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_206.width < this.var_69.width)
         {
            this.var_206.x = this._window.width - this.var_206.width;
            this.var_69.x = 0;
         }
         else
         {
            this.var_69.x = this._window.width - this.var_69.width;
            this.var_206.x = 0;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2055,param1.nutrition,param1.nutritionMax,this.const_2051,this.const_2046);
         this.updateStateElement(this.const_2049,param1.experience,param1.experienceMax,this.const_2052,this.const_2045);
         this.updateStateElement(this.const_2057,param1.energy,param1.energyMax,this.const_2050,this.const_2048);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2047,this.const_2054,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2053);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2056);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1361,_loc7_.width - 2,_loc7_.height - 2 - this.const_1361);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1361);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_480) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_206 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_206 != null)
         {
            this.var_54 = this.var_206.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_206.findChildByTag("close");
         if(_loc3_ != null)
         {
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClose);
         }
         this.var_69 = this._window.getListItemByName("button_list") as IItemListWindow;
         if(this.var_69 == null)
         {
            return;
         }
         _loc4_ = 0;
         while(_loc4_ < this.var_69.numListItems)
         {
            _loc12_ = this.var_69.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc12_ != null)
            {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_206.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_206.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_206.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_206.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
         ...
         var _loc10_:* = [];
         this.var_69.groupListItemsWithTag("CMD_BUTTON",_loc10_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_205 && this.var_205.getPetId() == this.var_480)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1704,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_588,this._widget.petData.ownerId);
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = this.var_69.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_69.getListItemByName(param1);
         if(_loc3_ != null)
         {
