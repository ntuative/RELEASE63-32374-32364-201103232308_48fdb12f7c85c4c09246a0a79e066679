package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1098,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_716,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_687,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_849,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_648,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1170)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1568;
            if(_loc2_ - this.var_1170 >= this.var_1835)
            {
               _loc3_ = this.var_1171;
               _loc4_ = this.var_1836;
               this.var_1170 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1171 >> 16 & 255;
               _loc11_ = this.var_1171 >> 8 & 255;
               _loc12_ = this.var_1171 & 255;
               _loc13_ = (_loc2_ - this.var_1170) / this.var_1835;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1837 + (this.var_1836 - this.var_1837) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_716,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_876:
               param2.setString(RoomObjectVariableEnum.const_727,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_851:
               param2.setString(RoomObjectVariableEnum.const_901,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_587:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_241)
               {
                  _loc5_ = "null";
               }
               this.var_549.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_785:
               _loc4_ = this.var_549.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_549.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1117,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1204:
               param2.setNumber(RoomObjectVariableEnum.const_687,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1142:
               param2.setNumber(RoomObjectVariableEnum.const_849,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_648,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1225,int(param1.bgOnly));
         this.var_1446 = this._color;
         this.var_1837 = this.var_1568;
         this.var_1171 = _loc3_;
         this.var_1836 = _loc4_;
         this.var_1170 = getTimer();
         this.var_1835 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_446,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1645,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1668,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1474,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_446,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_158 || _loc12_ == RoomPlaneData.const_319)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
