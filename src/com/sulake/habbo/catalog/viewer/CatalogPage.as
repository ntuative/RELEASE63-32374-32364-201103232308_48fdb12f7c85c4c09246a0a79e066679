package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1735:String = "ctlg_";
       
      
      protected var var_2080:XML;
      ...
      private var var_526:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1199:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_526 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1198);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1198);
      }
      ...
      {
         var _loc2_:String = const_1735 + param1;
         ...
         this.var_2080 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2080) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1562:
               if(this.var_1199 == null)
               {
                  this.var_1199 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1199);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1647:
               ...
               break;
            case CatalogWidgetEnum.const_1481:
            ...
            case CatalogWidgetEnum.const_1478:
               ...
               break;
            case CatalogWidgetEnum.const_1512:
            ...
            case CatalogWidgetEnum.const_1637:
               ...
               break;
            case CatalogWidgetEnum.const_1507:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_526.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_526 != null)
         {
            return this.var_526.dispatchEvent(param1);
         }
         return false;
      }
   }
