package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1749:String = "badge_bg_001_png";
      
      private const const_2028:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_75 = param10;
         this._assets = param8;
         this.var_321 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_140,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2306 = this.var_75.getBadgeName(this.var_301);
         this.var_2311 = this.var_75.getBadgeDesc(this.var_301);
         this.var_2308 = this.var_75.getAchievementNameForFacebook(this.var_301,this.var_321.userName,this.var_321.realName,this.var_1366);
         this.var_2309 = this.var_75.getAchievementDescForFacebook(this.var_301,this.var_321.userName,this.var_321.realName,this.var_1366);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2310 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_75.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_2002.toString());
         this.var_75.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1367.toString());
         this.var_75.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1367.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1685;
         var _loc17_:String = this.var_1685 == 0 ? "pixels" : "activitypoints";
         this.var_75.registerParameter(_loc16_,_loc17_,"" + this.var_2162);
         _loc15_.caption = this.var_75.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1749);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2028) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1367 <= 0 || !_loc21_)
         {
            ...
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_301,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_301,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_301,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_75.registerParameter(param1,"badge_name",this.var_2306);
         this.var_75.registerParameter(param1,"badge_desc",this.var_2311);
         this.var_75.registerParameter(param1,"badge_name_fb",this.var_2308);
         this.var_75.registerParameter(param1,"badge_desc_fb",this.var_2309);
         this.var_75.registerParameter(param1,"level",this.var_1366.toString());
         this.var_75.registerParameter(param1,"name",this.var_321.userName);
         return this.var_75.registerParameter(param1,"realname",this.var_321.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_321.events.removeEventListener(BadgeImageReadyEvent.const_140,this.onBadgeImageReady);
            this.var_321 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_301)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1749);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_301,this._feedTitleFb,this.var_2310,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               ...
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_301,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_301,"client.skip_post"));
               this.dispose();
               return;
         }
      }
