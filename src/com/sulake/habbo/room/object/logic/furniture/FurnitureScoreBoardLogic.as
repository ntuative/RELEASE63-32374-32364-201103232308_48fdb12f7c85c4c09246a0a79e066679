package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_421:int = 50;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_787 != _loc2_)
         {
            ...
            if(_loc3_ * const_421 > const_981)
            {
               this.var_1073 = const_981 / _loc3_;
            }
            else
            {
               this.var_1073 = const_421;
            }
            this.var_1481 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_787 && param1 >= this.var_1481 + this.var_1073)
            {
               _loc3_ = param1 - this.var_1481;
               _loc4_ = _loc3_ / this.var_1073;
               _loc5_ = 1;
               if(this.var_787 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1481 = param1 - (_loc3_ - _loc4_ * this.var_1073);
            }
         }
      }
   }
