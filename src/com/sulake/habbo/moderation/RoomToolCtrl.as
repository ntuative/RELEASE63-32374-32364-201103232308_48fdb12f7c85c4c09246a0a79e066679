package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1091:IDropMenuWindow;
      
      private var var_501:ITextFieldWindow;
      
      private var var_678:Boolean = true;
      
      private var var_947:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_381));
      ...
      public function populate() : void
      {
         ...
         this.var_1091 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1091);
         this.var_1091.procedure = this.onSelectTemplate;
         this.var_947 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1432 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1433 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_918,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_947.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1694,_loc2_,this.var_501.text,"",""));
         if(this.var_1432.isSelected || this.var_1433.isSelected || this.var_947.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1432.isSelected,this.var_1433.isSelected,this.var_947.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1723);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1615);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1091.selection];
         if(_loc3_ != null)
         {
            this.var_678 = false;
            this.var_501.text = _loc3_;
         }
      }
   }
}
