package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_417:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_185:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_569,this,null,true);
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            ...
            this.var_582 = param1;
            this.closeMenuView();
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_344,this,null);
            this.update(this,_loc2_);
         }
         _loc2_.recycle();
      }
      ...
      {
         if(this.var_185 != null && !this.var_185.disposed)
         {
            this.var_185.destroy();
            this.var_185 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_417) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_185 == null || this.var_185.disposed)
         {
            this.var_185 = context.create(name + "::submenu","",WindowType.const_485,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_185.setGlobalRectangle(_loc1_);
         }
         this.var_185.activate();
         return this.var_185;
      }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_185.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_886 = false;
            this.getTitleLabel().text = this.var_582 < this.var_251.length && this.var_582 > -1 ? this.var_251[this.var_582] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_532,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_385,var_84,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_582).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN || param1.type == WindowTouchEvent.const_522)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1179:
            case WindowMouseEvent.const_57:
               ...
               break;
            case WindowTouchEvent.const_828:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1082,this,null);
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_1144;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1096,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_251.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_756,this.var_251,PropertyStruct.const_146,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_756)
            {
