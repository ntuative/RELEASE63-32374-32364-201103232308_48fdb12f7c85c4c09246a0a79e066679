package com.sulake.habbo.avatar.actions
{
   public class ActionType
   {
      ...
      private var var_1597:Boolean = true;
      ...
      public function ActionType(param1:XML)
      {
         ...
         this._preventHeadTurn = String(param1.@preventheadturn) == "ParkBusCannotEnterMessageEvent";
         ...
         {
            this.var_1597 = _loc3_ == "ParkBusCannotEnterMessageEvent";
         }
      }
