package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1298:Number = 25;
      
      private static const const_1300:Number = 90;
      
      private static const const_966:int = 50;
      
      private static const const_1367:int = 50;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_635 = new Object();
         this.var_636 = new Array();
         this.var_634 = new Array();
         super();
         this._windowManager = param1;
         this.var_1444 = param2;
         this.var_770 = new Timer(const_1298);
         this.var_770.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_369[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_966 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_966 || param1.desktop.height - param1.y < const_1367;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            this.var_369.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_636[this.var_634.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_634[this.var_636.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         this.var_636.push(param1.name);
         this.var_634.push(param2);
         param1.addEventListener(WindowEvent.const_401,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_258,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_635[_loc3_] == null)
            {
               this.var_635[_loc3_] = new Array();
            }
            if(this.var_635[_loc3_].indexOf(param1) < 0)
            {
               this.var_635[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_369.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_369.splice(this.var_369.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_636[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_634[_loc2_];
               if(this.var_635[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_635[_loc3_].length)
                  {
                     this.repositionWindow(this.var_635[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_369.length)
         {
            _loc2_ = this._itemList[this.var_369[_loc7_]];
            if(_loc2_.active)
            {
