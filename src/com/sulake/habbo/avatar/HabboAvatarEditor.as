package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1348:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1349:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_730:ISessionDataManager;
      
      private var var_16:AvatarEditorView;
      
      private var var_1147:AvatarEditorHandler;
      ...
      private var var_939:IFigureData;
      ...
      private var var_1418:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_933 = FigureData.const_73;
         ...
         param1.root.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,this.method_4);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_197)
         {
            ...
            _loc2_.loadAvatarData(const_1348,FigureData.const_73);
            _loc3_.loadAvatarData(const_1349,FigureData.FEMALE);
            this.var_102 = new Map();
            this.var_508 = new Map();
            this.var_102.add(AvatarEditorFigureCategory.const_912,new BodyModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_221,new TorsoModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_745,new LegsModel(this));
            ...
            this.var_508.add(AvatarEditorSideCategory.const_105,new WardrobeModel(this));
            this.var_508.add(AvatarEditorSideCategory.const_431,new ClubPromoModel(this));
            this.var_197 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_939.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_939.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         if(this.var_16 != null)
         {
            if(!this.var_16.validateAvailableCategories(param3))
            {
               this.var_16.dispose();
               this.var_16 = null;
            }
         ...
         if(this.var_16 == null)
         {
            this.var_16 = new AvatarEditorView(this,this._windowManager,this._catalog,param3,!param4);
         }
         if(param1 != null)
         {
            param1.addChild(this.var_16.window);
         }
         else
         {
            if(this.var_266 == null)
            {
               this.var_266 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_266.addChild(this.var_16.window);
               if(param5)
               {
                  this.var_266.center();
               }
            ...
            this.var_266.visible = !this.var_266.visible;
         }
         this.var_16.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_912);
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_730 = param2 as ISessionDataManager;
      }
      ...
      {
         this.var_939 = this.var_507.getFigureData(AvatarType.const_113);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1147 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_625[this.var_933];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1418 != null)
         {
            ...
            this.var_1418.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1794;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1146 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1350)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1555.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1288.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1655)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1146 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1288.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1146 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_508.getValue(AvatarEditorSideCategory.const_105);
      }
