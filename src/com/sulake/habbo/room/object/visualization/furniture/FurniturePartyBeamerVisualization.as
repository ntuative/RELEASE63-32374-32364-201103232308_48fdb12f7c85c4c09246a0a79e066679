package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_421:int = 2;
      
      private static const const_975:int = 15;
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_783[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_783[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_783.length == 2)
            {
               return this.var_783[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_783.length == 2)
            {
               return this.var_783[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1205[param2];
         var _loc4_:int = this.var_1203[param2];
         var _loc5_:int = this.var_1204[param2];
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1205.push(Math.random() * _loc2_ * 1.5);
         this.var_1205.push(Math.random() * _loc2_ * 1.5);
         this.var_1203 = new Array();
         this.var_1203.push(1);
         this.var_1203.push(-1);
         this.var_1204 = new Array();
         this.var_1204.push(const_1391);
         this.var_1204.push(const_1390);
