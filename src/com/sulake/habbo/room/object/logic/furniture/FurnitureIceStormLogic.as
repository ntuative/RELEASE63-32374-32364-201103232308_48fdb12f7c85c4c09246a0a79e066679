package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1567 = _loc2_;
            this.var_2089 = param1.extra;
            this.var_1055 = lastUpdateTime + _loc3_;
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            this.var_1055 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1567,String(this.var_1567),this.var_2089);
