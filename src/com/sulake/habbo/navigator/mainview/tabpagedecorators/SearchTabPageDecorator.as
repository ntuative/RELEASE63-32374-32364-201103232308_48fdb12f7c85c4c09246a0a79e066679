   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1657 == null)
         {
            ...
            this.var_1657 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_1657.searchStr.setText(this._navigator.data.guestRoomSearchResults.method_2);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_383)
            {
               ...
               this._navigator.registerParameter("navigator.tagsearchresults","tag_name",this.padCommas(this._navigator.data.guestRoomSearchResults.method_2));
               _loc4_.visible = true;
            }
            else
            {
               ...
               this._navigator.registerParameter("navigator.textsearchresults","search_str","" + this._navigator.data.guestRoomSearchResults.method_2);
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_235,Tabs.const_257,"-1",MainViewCtrl.const_693);
      }
