package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2023:int = 1000;
      ...
      private var var_857:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_199 = new Timer(this.const_2023);
         this.var_199.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_199.stop();
            this.var_199.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_199 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_181.isActive)
         {
            _loc2_ = this.var_181.secondsLeft / Number(this.var_181.duration);
            this.var_856.width = _loc2_ * this.var_309;
         }
         else
         {
            this.var_856.width = 0;
            this.var_199.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_696 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_696 == null)
            {
               return;
            }
         ...
         if(!this.var_181.isActive)
         {
            this.var_696.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_696.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_696.text;
         var _loc2_:int = this.var_181.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_181.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_181.isActive)
         {
         ...
         else
         {
            ...
            this.var_857 = this._window.findChildByName("effect_hilite");
            this.var_857.visible = false;
         }
         this.setTimeLeft();
         this.var_856 = this._window.findChildByName("loader_bar");
         if(this.var_856 != null)
         {
            this.var_309 = this.var_856.width;
            this.var_199.start();
            this.onUpdate();
         }
         if(this.var_181.icon)
         {
            this.setElementBitmap("effect_icon",this.var_181.icon);
         }
      }
