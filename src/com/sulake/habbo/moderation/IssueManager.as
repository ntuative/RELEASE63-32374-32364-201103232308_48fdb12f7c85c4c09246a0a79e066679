package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1213:String = "issue_bundle_open";
      
      public static const const_666:String = "issue_bundle_my";
      
      public static const const_1033:String = "issue_bundle_picked";
      
      public static const const_1437:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_630 = new IssueBrowser(this,this.var_67.windowManager,this.var_67.assets);
         this.var_1163 = [];
         this.var_1164 = [];
         this.var_953 = new Map();
         this.var_2531 = parseInt(this.var_67.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1819 = new Timer(const_1437,0);
         this.var_1819.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1819.start();
      }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_352 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_630 == null || !this.var_630.isOpen())
         {
            this.var_67.soundManager.playSound(HabboSoundTypesEnum.const_1111);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1533)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(this.var_1163.indexOf(param1.issueId) != -1)
         {
            ...
            {
               if(param1.state == IssueMessageData.const_352)
               {
         ...
         {
            _loc6_ = this.getBundles(const_666);
            _loc7_ = false;
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2531);
            }
         }
         ...
         for each(_loc4_ in this.var_107)
         {
            switch(param1)
            {
               case const_1213:
                  ...
                  break;
               case const_666:
                  if(_loc4_.state == IssueMessageData.const_352 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_352 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
