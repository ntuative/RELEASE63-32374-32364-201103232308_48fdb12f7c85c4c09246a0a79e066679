package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_561,RoomObjectFurnitureActionEvent.const_557,RoomObjectFurnitureActionEvent.const_457,RoomObjectFurnitureActionEvent.const_567,RoomObjectWidgetRequestEvent.const_156];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_635) == 1)
         {
            object.getModelController().setString(RoomWidgetEnum.const_473,RoomWidgetEnum.const_1059);
