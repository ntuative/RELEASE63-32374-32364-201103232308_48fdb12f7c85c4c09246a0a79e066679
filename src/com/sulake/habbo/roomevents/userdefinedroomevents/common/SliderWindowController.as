package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_966);
         }
      ...
      {
         return int(this.var_1779 * (Number(param1 - this._minValue) / (this.var_1175 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1779 * (this.var_1175 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_967)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_188)
            {
               this.var_967 = false;
            }
         }
         if(!this.var_967 || param1.type != WindowEvent.const_401)
         {
            return;
         }
         if(this.var_637 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_637 != 0)
            {
               _loc3_ = this.var_966 + this.var_637;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_745 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_745.width,this.var_745.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_745,this.var_745.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_744 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_744.width,this.var_744.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_744,this.var_744.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1779 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_745 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_744 = BitmapData(_loc2_.content);
      }
   }
}
