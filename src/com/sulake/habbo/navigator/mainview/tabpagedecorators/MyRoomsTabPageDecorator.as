package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2910:IWindowContainer;
      
      private var var_517:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_517 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_517.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_517 == null ? 0 : int(this.var_517.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_809;
         }
         if(param1 == 3)
         {
            return Tabs.const_905;
         }
         if(param1 == 4)
         {
            return Tabs.const_633;
         }
         return Tabs.const_271;
      }
   }
}
