package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1306:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_184.state = RoomChatHistoryPulldown.const_230;
         ...
         this.var_49 = param2.createWindow("chatscroller","",HabboWindowType.const_1181,HabboWindowStyle.const_43,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_184.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_230);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_184.state == RoomChatHistoryPulldown.const_410 || this.var_184.state == RoomChatHistoryPulldown.const_470;
      }
      ...
      {
         if(!this.var_411 && !this.var_1848)
         {
            this.var_411 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_184.state = RoomChatHistoryPulldown.const_410;
            if(this._widget != null)
            {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_412 > 0 && param2)
         {
            if(this.var_1624)
            {
               if(Math.abs(param1 - this.var_412) <= const_1189)
               {
                  return;
               }
               this.var_1624 = false;
            ...
            if(this.var_411)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_49.scrollV < 1 - const_1306 / this.var_49.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1625)
               {
