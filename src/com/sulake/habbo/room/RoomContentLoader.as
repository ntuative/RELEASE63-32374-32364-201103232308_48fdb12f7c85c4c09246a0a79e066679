package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_818:String = "RCL_LOADER_READY";
      
      private static const const_335:String = "RCL_PUBLICROOM_";
      
      private static const const_1771:int = 0;
      
      private static const const_986:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_423:String = "place_holder";
      
      private static const const_621:String = "wall_place_holder";
      
      private static const const_622:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_423;
      
      private static const const_623:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_985:String = "selection_arrow";
      ...
      private var var_996:Map = null;
      
      private var var_210:PublicRoomData = null;
      
      private var var_1495:Map = null;
      ...
      {
         if(this._state >= const_986)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2673 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2675 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2671 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_997.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_321.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_537.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_537.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_794.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_448.add(_loc3_,_loc4_);
               if(this.var_378[_loc7_] == null)
               {
                  this.var_378[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_655.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2672)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_818));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_535 != null)
         {
            this.var_535.remove(param1);
            this.var_535.add(param1,param2);
         }
         if(this.var_536 != null)
         {
            this.var_536.remove(param2);
            this.var_536.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_535 != null)
         {
            _loc2_ = this.var_535.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_536 != null)
         {
            _loc2_ = this.var_536.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         return [const_423,const_621,const_622,const_623,TILE_CURSOR,const_985];
      }
      ...
      {
         var _loc3_:String = this.var_655.getValue(param1) as String;
      ...
      {
         return this.var_997.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_996[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_655.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_794.getValue(param1) != null)
         {
            return this.var_794.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_210 != null && this.var_210.hasWorldType(const_335 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_232 || param1 == RoomObjectVisualizationEnum.const_68 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2671 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_29:
                     if(this.var_378[_loc4_] == null)
                     {
                        this.var_378[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_372,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1495.getValue(param1) != null)
         {
            this.var_210 = this.var_1495.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_877,this.onContentLoaded);
            _loc6_ = 0;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1529);
               return;
            }
         }
      }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_996.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1495.add(param1,_loc4_);
         this.var_210 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_795.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_795.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_537.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_795.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_537.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_537.add(_loc5_,_loc4_);
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_335 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_335 + param1) == RoomObjectCategoryEnum.const_78)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_210.getWorldHeightScale(const_335 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_210 != null)
         {
            return this.var_210.getWorldScale(const_335 + param1);
         }
         return 32;
      }
