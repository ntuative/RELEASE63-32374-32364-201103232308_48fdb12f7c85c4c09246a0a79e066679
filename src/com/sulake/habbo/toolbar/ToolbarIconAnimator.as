package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1567 = param1.nextState;
         this.var_1543 = param1.loop;
         if(param1.background != null)
         {
            this.var_831 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_1037.push(new XML());
               this.var_1035.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_1035[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1543 == true || this.var_1036 == 0)
         {
            if(this.var_1037.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_1037.length)
               {
                  this._frame = 0;
                  ++this.var_1036;
               }
      ...
      {
         return this.var_1037.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1543 == false && this.var_1036 == 1 && this.var_1567 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_1035.length)
         {
            _loc2_ = this.var_1035[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_831.width),Math.max(param2.height,this.var_831.height),true,0);
            _loc4_ = _loc3_.height - this.var_831.rect.height;
            _loc3_.copyPixels(this.var_831,this.var_831.rect,new Point(0,_loc4_),null,null,true);
