package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView
   {
      ...
      public function InfoStandJukeboxView(param1:InfostandWidget, param2:String, param3:IHabboCatalog, param4:IHabboSoundManager)
      {
         ...
         this.var_512 = param4;
         this.var_512.events.addEventListener(NowPlayingEvent.const_798,this.onNowPlayingChanged);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_512)
         {
            this.var_512.events.removeEventListener(NowPlayingEvent.const_798,this.onNowPlayingChanged);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_69.numListItems)
            {
               _loc4_ = this.var_69.getListItemAt(_loc5_);
               _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClicked);
               _loc5_++;
            }
         }
         this.var_976 = this.var_206.findChildByTag("catalog");
         if(this.var_976 != null)
         {
            this.var_976.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         var _loc2_:IPlayListController = this.var_512.musicController.getRoomItemPlaylist();
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            if(_loc6_ != -1)
            {
               _loc7_ = this.var_512.musicController.getSongInfo(_loc6_);
               if(_loc7_ != null)
               {
         ...
         this.var_69.visible = _loc3_ || _loc4_ || _loc5_;
         this.updateWindow();
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_54.addListItem(this.var_976);
            }
            this.var_976.visible = param1;
         }
         else
         {
            this.var_54.removeListItem(this.var_976);
         }
      }
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this._widget.mainContainer.visible && this._window.visible)
         {
            if(param1.id != -1)
            {
               _loc2_ = this.var_512.musicController.getSongInfo(param1.id);
               if(_loc2_ != null)
               {
