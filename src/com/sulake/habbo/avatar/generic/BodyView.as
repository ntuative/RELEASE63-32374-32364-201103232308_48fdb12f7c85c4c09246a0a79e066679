package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_616:String = "tab_boy";
      
      private const const_617:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_68.controller.gender)
         {
            case FigureData.const_73:
               activateTab(this.const_616);
               inactivateTab(this.const_617);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_617);
               inactivateTab(this.const_616);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_616:
                  var_68.controller.gender = FigureData.const_73;
