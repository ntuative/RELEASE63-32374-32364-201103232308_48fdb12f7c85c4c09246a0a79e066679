package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_963:int = -2;
      
      private static const const_1356:String = "tile_cursor";
      ...
      private static const const_422:int = 15;
      
      private static const const_961:int = 40;
      ...
      private var var_50:IRoomManager = null;
      
      private var var_942:IRoomRendererFactory = null;
      
      private var var_759:IRoomObjectFactory = null;
      ...
      private var var_760:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_760 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_759.release(new IIDRoomObjectFactory());
            this.var_759 = null;
         }
         ...
         if(this.var_50 != null)
         {
            this.var_50.release(new IIDRoomManager());
            this.var_50 = null;
         }
         if(this.var_942 != null)
         {
            this.var_942.release(new IIDRoomRendererFactory());
            this.var_942 = null;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_50 != null)
         {
            ...
            this.var_50.update(param1);
            _loc2_ = this.var_50.getRoom(this.getRoomIdentifier(this.var_99,this.var_98));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         while(_loc2_ < this.var_314.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_99 || _loc6_ != this.var_98 || !this.var_1155)
                  {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc14_ || _loc9_.screenHt != _loc15_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc))
               {
                  ...
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_925) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_831) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_884) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_759 = param2 as IRoomObjectFactory;
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_50 = param2 as IRoomManager;
         if(this.var_50 != null)
         {
            this.var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_29);
            this.var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_26);
            this.var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_34);
            this.var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_293);
            this.var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_78);
            this.var_50.setContentLoader(this.var_13);
         }
         this.initializeRoomManager();
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_942 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_818,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_818)
         {
            this.var_2520 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_316.events.addEventListener(AdEvent.const_590,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_321;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_759 != null)
         {
            this.var_759.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_759 == null || this.var_506 == null || this.var_50 == null || this.var_942 == null || this._communication == null || this.var_166 == null || !this.var_2520)
         {
            return;
         }
         this.var_50.initialize(<nothing/>,this);
      }
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1132,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_534,param1,param2));
            }
            else
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1132);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function getRoom(param1:int, param2:int) : IRoomInstance
      {
         ...
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         return this.var_50.getRoom(_loc3_);
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_701,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = this.var_50.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1104,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_656,1,true);
            _loc12_ = parseInt(this.var_166.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1188,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_331,const_614,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_656,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_865,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_782,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_831,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_925,_loc17_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1195,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_876,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_851,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_737,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_587,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_241);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_683,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_906,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_683,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_906,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1090,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1201,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_963,const_1356,RoomObjectCategoryEnum.const_293);
         if(this.var_166.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_962,const_1355,RoomObjectCategoryEnum.const_293);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_331,RoomObjectCategoryEnum.const_78);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_876,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_851,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_737,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1538,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1142,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1204,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         this.var_50.disposeRoom(_loc3_);
         var _loc4_:RoomInstanceData = this.var_314.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_824,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = this.var_50.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_942.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1034;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_865);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_683);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_906);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1090);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1201);
      ...
      {
         var _loc4_:String = this.getRoomIdentifier(param1,param2);
         var _loc5_:IRoomInstance = this.var_50.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1424;
         var _loc9_:int = param3 - this.var_1426;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1155 = true;
               this.var_944 = false;
               this.var_2521 = this.var_1424;
               this.var_2522 = this.var_1426;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1155)
            {
               if(!this.var_944)
               {
                  _loc8_ = param2 - this.var_2521;
                  _loc9_ = param3 - this.var_2522;
                  if(_loc8_ <= -const_422 || _loc8_ >= const_422 || _loc9_ <= -const_422 || _loc9_ >= const_422)
                  {
                     this.var_944 = true;
                  }
                  _loc8_ = 0;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_591,this.var_99,this.var_98,-1,RoomObjectCategoryEnum.const_161));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_77 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_331,const_614);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_98,this.var_1425);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1424 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1426 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_98,this.var_1425);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_98,this.var_1425);
         if(_loc1_ != null)
         {
      ...
      public function getRoomObjectWithIndex(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc5_:String = this.getRoomIdentifier(param1,param2);
         var _loc6_:IRoomInstance = this.var_50.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_962,RoomObjectCategoryEnum.const_293);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_963,RoomObjectCategoryEnum.const_293);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_228,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_368,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_377,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_635,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1030,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1105,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_397,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         var _loc10_:ISelectedRoomObjectData = this.getPlacedObjectData(param1,param2);
         if(_loc10_ && Math.abs(_loc10_.id) == param3 && _loc10_.category == RoomObjectCategoryEnum.const_29)
         {
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_228,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_368,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_377,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1034,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_397,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1240) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1149);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_587,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_785,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_397,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.var_50.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:IRoomInstance = this.var_50.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_750,this.var_99,this.var_98,param2,param3));
            }
         }
      }
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = this.var_50.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_358);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_319,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_727,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_901,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_674,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_587,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_510 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this.var_50.getRoom(const_613);
         if(_loc11_ == null)
         {
            _loc11_ = this.var_50.createRoom(const_613,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_760.reserveNumber();
         ...
         switch(_loc13_)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_358,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_183,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_742,int(param2));
               }
               break;
         ...
         {
            this.var_1154.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1020,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_760.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_99,this.var_98,const_331,RoomObjectCategoryEnum.const_78,param1);
      }
      
      public function isRoomObjectContentAvailable(param1:String) : Boolean
      {
         return this.var_50.isContentAvailable(param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_50.getRoom(const_613);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1020);
               ...
               this.var_760.freeNumber(_loc10_ - 1);
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1247,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1208,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1168,RoomObjectVariableEnum.const_395,param1.clickUrl);
