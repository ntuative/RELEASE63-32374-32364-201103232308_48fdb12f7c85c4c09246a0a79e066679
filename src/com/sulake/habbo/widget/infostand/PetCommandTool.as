package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_414:IFrameWindow;
      ...
      private const const_2027:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_348 = new Timer(this.const_2027);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1077.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_480);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1077.getValue(this.var_480) as CommandConfiguration;
      ...
      {
         this.var_1077.remove(param1);
         this.var_1077.add(param1,param2);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.setParamFlag(WindowParam.const_93,true);
         this.var_42.context.getDesktopWindow().addEventListener(WindowEvent.const_47,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_414 == null)
         {
            ...
            this.var_414 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_414 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_414.x = 200;
            this.var_414.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_342,this.var_480));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_541,this.var_480,this.var_1639 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_541,this.var_480,this.var_1639 + " " + _loc5_);
