package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_2001:Map = null;
      
      private var var_1273:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1272:Number = 0.0;
      
      private var var_828:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_462.length)
            {
               _loc2_ = this.var_462.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_327 != null)
         {
            ...
            {
               _loc2_ = this.var_327.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_744,RoomWidgetChatSelectAvatarMessage.const_915];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_744:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1031))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1031))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_915:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_327.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_462.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_681.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_681.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_186)
                                    {
                                       this.var_327.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_462.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1272 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1272);
            }
            if(this.var_828 == null)
            {
               ...
               this.var_550.y = 0;
               this.var_550.z = 0;
               this.var_828 = _loc4_.getScreenPoint(this.var_550);
               this.var_1272 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_550.x = 0;
            this.var_550.y = 0;
            this.var_550.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_550);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_828.x || _loc8_.y != this.var_828.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_828,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_327)
         {
            _loc2_ = this.var_327.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_462)
         {
            _loc2_ = this.var_462.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1273.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_681.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_2001.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_2001.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_327)
            {
               this.var_327.add(_loc3_,param2);
            }
         }
      }
   }
