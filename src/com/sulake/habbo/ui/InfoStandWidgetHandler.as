   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_160,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_140,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_160,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_140,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_898);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_194);
         _loc1_.push(RoomWidgetFurniActionMessage.const_453);
         _loc1_.push(RoomWidgetFurniActionMessage.const_586);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_634);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_882);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_811);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1461);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_342);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_767);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_491)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_342 || param1.type == RoomWidgetUserActionMessage.const_461 || param1.type == RoomWidgetUserActionMessage.const_484)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_671:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1250,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_903:
               ...
               break;
            case RoomWidgetUserActionMessage.const_898:
            ...
            case RoomWidgetFurniActionMessage.const_586:
               ...
               break;
            case RoomWidgetUserActionMessage.const_342:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_634:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_882:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_811:
            ...
            case RoomWidgetPetCommandMessage.const_541:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_767:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_473) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_473);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_368);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1030);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1105);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_186)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc13_.webID);
                  return null;
               }
               if(_loc13_.type == RoomObjectTypeEnum.const_195)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_870)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_571);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_121)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_141)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_761);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1156;
                  }
                  if(!_loc30_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1019;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1621);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_761);
