package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_997:String = "bg";
      ...
      {
         this.var_16.getChildByName(const_997).style = HabboWindowStyle.const_32;
      }
      
      public function deActivate() : void
      {
         this.var_16.getChildByName(const_997).style = 3;
      }
      ...
      public function set view(param1:IWindowContainer) : void
      {
         ...
         this.var_16 = param1;
         this.var_16.procedure = this.eventProc;
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_603 != null && this.var_603 == param2)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_229)
         {
            this.var_603 = null;
         }
      }
