package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1378:String = "pixelbalance";
      
      private static const const_1379:String = "badges";
      
      private static const const_1375:String = "selectbadge";
      
      private static const const_1374:String = "inventory";
      
      private static const const_1372:String = "selectfurni";
      
      private static const const_1373:String = "credits";
      
      private static const const_1377:String = "friendlist";
      
      private static const const_1376:String = "pet_inventory";
      ...
      private var var_776:IHabboToolbar;
      ...
      private var var_519:HabboNotificationViewManager;
      
      private var var_230:HabboAlertDialogManager;
      
      private var var_777:ParkBusDialogManager;
      
      private var var_2586:Boolean;
      
      private var var_972:ClubGiftNotification;
      
      private var var_973:ClubEndingNotification;
      
      private var var_971:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_970);
         }
         var _loc6_:Map = this.var_970["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_776)
         {
            this.var_776.release(new IIDHabboToolbar());
            this.var_776 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_970["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_230 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_776 = IHabboToolbar(param2);
         this.var_776.events.addEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_70)
         {
            ...
            this.var_519 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_970["styles"],this.var_970["view"],this.var_776);
            ...
            this._communication.addHabboConnectionMessageEvent(new BadgeReceivedMessageEvent(this.method_5));
            registerUpdateReceiver(this.var_519,1);
            registerUpdateReceiver(this,2);
            this.var_321.events.addEventListener(BadgeImageReadyEvent.const_140,this.onBadgeImage);
            this.var_776.events.addEventListener(HabboToolbarEvent.const_536,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1454[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_321);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1454[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1454[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1732,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_321.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1092,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1092,null);
            }
         }
      }
      
      private function method_5(param1:BadgeReceivedMessageEvent) : void
      {
         var _loc6_:* = null;
         var _loc9_:* = null;
         ...
         if(this.var_321.userId == _loc3_)
         {
            ...
            _loc9_ = this.var_321.getBadgeImage(_loc4_);
            this.addItem(!!_loc6_ ? _loc6_.value : "notifications.text.received.badge",NotificationType.const_784,_loc9_,_loc4_);
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1438,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_507.createAvatarImage(param2,AvatarScaleType.const_53);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_321.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_76)
               {
                  _loc9_ = this.var_321.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_321.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1666,_loc5_);
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1042)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1711,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1649)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_973 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_971 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_519.isSpaceAvailable() && this.var_1181.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_519.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1379:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_303);
               }
               break;
            case const_1375:
               break;
            ...
            case const_1376:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_151);
               }
               break;
            case const_1372:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_519.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_386;
            }
            if(param2 == 3002)
            {
               return FurniCategory.const_362;
            }
            if(param2 == 4057)
            {
               return FurniCategory.const_398;
            }
            return 1;
         }
         return 1;
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_230 == null)
         {
            return;
         }
         this.var_230.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_230.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_230.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_230.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_230.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_777 == null)
         {
            this.var_777 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_777 != null)
         {
            this.var_777.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_507.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_53);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2586)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_784,null);
            this.var_2586 = true;
      ...
      {
         if(param2.type == WindowEvent.const_182 || param2.type == WindowEvent.const_897)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_972 && this.var_972.visible)
         {
            return;
         }
         this.var_972 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_784,_loc6_);
      }
   }
}
