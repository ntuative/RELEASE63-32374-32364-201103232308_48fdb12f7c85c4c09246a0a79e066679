package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      private static const const_1393:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1393)
         {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(_loc5_ != null)
         {
            ...
            _loc10_ = _loc5_.method_3().getQuestionTitleArray();
