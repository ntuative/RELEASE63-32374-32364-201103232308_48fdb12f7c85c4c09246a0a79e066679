package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1951:int = "F".charCodeAt(0);
      
      public static const const_1904:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_621 = param1.figure;
         this.var_1674 = param1.motto;
         this.var_1675 = param1.lastAccess;
         this.var_1409 = param1.categoryId;
         this.var_1676 = param1.realName;
