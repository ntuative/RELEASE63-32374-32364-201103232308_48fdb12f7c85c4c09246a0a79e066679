package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1675:uint = 9;
      
      public static const const_199:uint = 0;
      
      public static const const_174:uint = 1;
      
      public static const const_371:uint = 2;
      
      public static const const_286:uint = 3;
      ...
      public function TradingModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager)
      {
         ...
         this.var_56 = new TradingView(this,param2,param4,param5,param6);
      }
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_56.updateItemList(this.var_755);
         this.var_56.updateItemList(this.var_1415);
      ...
      public function close() : void
      {
         if(this.var_771)
         {
            if(this._state != const_199 && this._state != const_231)
            {
      ...
      {
         this.var_56.setMinimized(param1 != InventoryCategory.const_79);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_754 + " OTHER: " + this.var_1141);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1114);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_754 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1141 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_56.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_56.alertPopup(TradingView.const_1107);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_264.length < const_1675)
         {
