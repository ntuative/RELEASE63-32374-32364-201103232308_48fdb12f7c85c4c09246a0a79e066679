package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1257:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_850:Number;
      
      protected var var_563:Number;
      
      protected var var_562:Boolean;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_640 ? true : null;
         }
      ...
      {
         this.var_850 = param1;
         this._field.scrollH = this.var_850 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_850 * this.maxScrollH,this.var_563 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_850 = this.var_850;
         _loc1_.var_563 = this.var_563;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1227) ? new PropertyStruct(PropertyDefaults.const_838,this._field.antiAliasType,PropertyStruct.const_56,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1075) : PropertyDefaults.const_1620);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1074 ? new PropertyStruct(PropertyDefaults.const_920,this._autoSize,PropertyStruct.const_56,true,PropertyDefaults.const_1248) : PropertyDefaults.const_1545);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_124,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_234,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1197 ? new PropertyStruct(PropertyDefaults.const_1176,this._field.gridFitType,PropertyStruct.const_56,true,PropertyDefaults.const_1244) : PropertyDefaults.const_1707);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_778) ? new PropertyStruct(PropertyDefaults.const_370,this._field.textColor,PropertyStruct.const_124,true) : PropertyDefaults.const_1221);
         ...
         _loc1_.push(this.var_41.left != PropertyDefaults.const_724 ? new PropertyStruct(PropertyDefaults.const_264,this.var_41.left,PropertyStruct.const_41,true) : PropertyDefaults.const_444);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_896 ? new PropertyStruct(PropertyDefaults.const_217,this.var_41.top,PropertyStruct.const_41,true) : PropertyDefaults.const_475);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_647 ? new PropertyStruct(PropertyDefaults.const_239,this.var_41.right,PropertyStruct.const_41,true) : PropertyDefaults.const_472);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_629 ? new PropertyStruct(PropertyDefaults.const_270,this.var_41.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_489);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1178 ? new PropertyStruct(PropertyDefaults.const_819,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1593);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_265,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_265,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_265,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
