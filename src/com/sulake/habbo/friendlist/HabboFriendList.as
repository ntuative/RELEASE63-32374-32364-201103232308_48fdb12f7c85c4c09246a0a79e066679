package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2380:FriendListLookAndFeel;
      
      private var var_425:FriendListTabs;
      
      private var var_16:FriendListView;
      
      private var var_1740:OpenedToWebPopup;
      ...
      {
         this.var_2380 = new FriendListLookAndFeel();
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_607.stop();
            this.var_607.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_607 = null;
         }
         ...
         if(this.var_730)
         {
            this.var_730.release(new IIDSessionDataManager());
            this.var_730 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1740 = new OpenedToWebPopup(this);
         }
         this.var_1740.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         this.var_16.mainWindow.activate();
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_91,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_357.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_188.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_327,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1113.createAvatarImage(param1,AvatarScaleType.const_89,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "ParkBusCannotEnterMessageEvent";
      }
      ...
      {
         this.var_188 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this.var_16 = new FriendListView(this);
         ...
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_1216,this.getText("friendlist.friends")));
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_353,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_607)
         {
            this.var_607 = new Timer(120000);
            this.var_607.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_607.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_102.findCategory(FriendCategory.const_353);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      {
         var _loc1_:* = null;
         if(this.var_16.isFriendListOpen())
         {
            this.var_16.close();
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_425.findTab(FriendListTab.const_94).setNewMessageArrived(true);
            this.refreshToolBarIcon();
         }
         this.var_16.refresh("buddyRequests");
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_425.findTab(FriendListTab.const_94);
         _loc4_.setNewMessageArrived(true);
         this.refreshToolBarIcon();
         this.var_16.refresh("newBuddyRequest");
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_16.refresh("friendListUpdate");
      }
      ...
      {
         var _loc2_:FriendListTab = this.var_425.findTab(FriendListTab.const_94);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_730 || !this.var_357)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_730.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_357.vipLimit;
         }
         else if(this.var_730.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_42))
         {
