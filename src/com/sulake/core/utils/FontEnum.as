package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_336:Map = new Map();
      
      private static var var_1246:Boolean = false;
      ...
      {
         return const_336.getValue(param1) != null;
      }
      ...
      public static function registerFont(param1:Class) : Font
      {
         ...
         const_336.add(_loc4_.fontName,_loc4_);
         return _loc4_;
      }
      ...
      public static function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            _loc3_ = const_336.getValue(_loc2_.fontName);
            if(!_loc3_ || _loc3_.fontType != _loc2_.fontType || _loc3_.fontStyle != _loc2_.fontStyle)
            {
               const_336.add(_loc2_.fontName,_loc2_);
            }
            _loc5_++;
         }
      }
