package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1759 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1125 = this.var_1759.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1125)
         {
            this.var_1125.procedure = this.onButtonClick;
         }
         this.var_1124 = this.var_1759.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1124)
         {
            this.var_1124.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_260 >= this.var_75.length - 1)
         {
            this.var_1124.disable();
         }
         else
         {
            this.var_1124.enable();
         }
         if(this.var_260 <= 0)
         {
      ...
      {
         ++this.var_260;
         this.var_260 = Math.min(this.var_260,this.var_75.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_260;
         this.var_260 = Math.max(this.var_260,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_75[this.var_260][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_75[this.var_260][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_75[this.var_260][1]).value;
