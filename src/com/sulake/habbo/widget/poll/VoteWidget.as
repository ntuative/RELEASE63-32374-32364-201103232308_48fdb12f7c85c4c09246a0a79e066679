package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_154,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_154,this.showVoteResult);
      }
      ...
      private function updateTimerView() : void
      {
         ...
         var _loc1_:int = getTimer() - this.var_1812;
      ...
      {
         var _loc2_:int = getTimer() - this.var_1812;
