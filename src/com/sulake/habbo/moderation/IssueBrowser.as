package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2069:String = "my_issues";
      
      private const const_2067:String = "open_issues";
      
      private const const_2068:String = "picked_issues";
      
      private const const_2077:String = "closed_issues";
      ...
      private var var_386:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_386 == _loc2_)
         {
            return;
         }
         if(this.var_386 != null)
         {
            this.var_386.visible = false;
         }
         this.var_386 = _loc2_;
         if(this.var_386 == null)
         {
         ...
         this.var_386.view.width = this.var_277.container.width;
         this.var_386.view.height = this.var_277.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2069:
               ...
               {
                  this.var_1955 = new MyIssuesView(this.issueManager,this,this.var_277.container);
               }
               return this.var_1955;
            case this.const_2067:
               if(this.var_1953 == null)
               {
                  this.var_1953 = new OpenIssuesView(this.issueManager,this,this.var_277.container);
               }
               return this.var_1953;
            case this.const_2068:
               if(this.var_1954 == null)
               {
                  this.var_1954 = new PickedIssuesView(this.issueManager,this,this.var_277.container);
               }
