package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1160:IHabboHelp;
      ...
      {
         this.var_1438 = RoomDesktop.const_582;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1160.release(new IIDHabboHelp());
            this.var_1160 = null;
         }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1814 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_316.events.addEventListener(AdEvent.const_583,this.adEventHandler);
            this.var_316.events.addEventListener(AdEvent.const_477,this.adEventHandler);
            this.var_316.events.addEventListener(AdEvent.const_590,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1160 = param2 as IHabboHelp;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_440,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_148,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_564,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_574,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_499,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_900,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1110,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1172,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_799,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_813,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_527,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_136,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_127,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_487,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_135,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserNotificationEvent.const_109,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.SESSION_ENDED:
               if(param1.session != null)
               {
                  ...
                  this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_138,HabboToolbarIconEnum.ZOOM));
                  this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_138,HabboToolbarIconEnum.MEMENU));
                  this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_138,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_252:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_900:
            ...
            case RoomSessionErrorMessageEvent.const_655:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_799:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_859:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_813:
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_701,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_824,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_534,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_842,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_909,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_556 || param1.type == RoomEngineEvent.const_534)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_701:
               _loc5_ = false;
               ...
               if(this._roomEngine != null)
               {
                  ...
                  if(!this._roomEngine.isPublicRoomWorldType(this._roomEngine.getWorldType(param1.roomId,param1.roomCategory)))
                  {
                     ...
                     _loc7_.iconState = "2";
                     this.var_188.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_803);
               ...
               if(this.var_1438 != RoomDesktop.const_582)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_322,this.var_1438);
               }
               if(this.var_316 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_824:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.sessionDataManager = this.var_321;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_507;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_188;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1814;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_316;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1160;
         _loc3_.moderation = this.var_952;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_512;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_322);
            if(_loc3_ != RoomDesktop.const_582)
            {
