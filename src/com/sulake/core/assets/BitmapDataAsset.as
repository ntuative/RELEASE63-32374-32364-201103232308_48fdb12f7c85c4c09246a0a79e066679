package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_565:uint = 0;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_105 is BitmapDataAsset)
         {
            ...
            this.var_1356 = BitmapDataAsset(this.var_105).var_1356;
            this.var_1355 = BitmapDataAsset(this.var_105).var_1355;
            if(this._bitmap != null)
            {
               this.var_105 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1356 = _loc4_ == "1" || _loc4_ == "ParkBusCannotEnterMessageEvent";
                  break;
               case "flipV":
                  this.var_1355 = _loc4_ == "1" || _loc4_ == "ParkBusCannotEnterMessageEvent";
                  break;
            }
            _loc2_++;
         }
