package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1006:uint = 11;
      ...
      private var var_214:IHabboFriendList;
      
      private var var_1264:IHabboWindowManager;
      ...
      private var var_674:FramerateTracker = null;
      
      private var var_281:LatencyTracker = null;
      
      private var var_675:LagWarningLogger = null;
      
      private var var_676:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_674 = new FramerateTracker();
         this.var_281 = new LatencyTracker();
         this.var_675 = new LagWarningLogger();
         this.var_676 = new ToolbarClickTracker(this);
         this.var_1537 = new Array(const_1006);
         var _loc4_:int = 0;
         while(_loc4_ < const_1006)
         {
            this.var_1537[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1510,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1450,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1612,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_780,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1264)
            {
               this.var_1264.release(new IIDHabboWindowManager());
               this.var_1264 = null;
            }
            if(this.var_316)
            {
            ...
            if(this.var_214)
            {
               ...
               {
                  Component(this.var_214).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_214).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_214).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_214).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_214).events.removeEventListener(HabboFriendListTrackingEvent.const_405,this.onFriendlistTrackingEvent);
               }
               this.var_214.release(new IIDHabboFriendList());
               this.var_214 = null;
            }
            if(this.var_132)
            {
            ...
            if(this.var_188)
            {
               ...
               {
                  this.var_188.events.removeEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_195)
         {
            ...
            this.trackLoginStep(HabboLoginTrackingStep.const_1728);
            if(this.var_195)
            {
               ...
               if(this.var_674 != null)
               {
                  this.var_674.configure(this.var_195);
               }
               if(this.var_676 != null)
               {
                  this.var_676.configure(this.var_195);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_807,this.onConnectionEvent);
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1443);
         }
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1682);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1592);
               break;
            case HabboCommunicationEvent.const_807:
               this.trackLoginStep(HabboLoginTrackingStep.const_1625,String(this._communication.port));
               break;
      ...
      {
         this.var_1264 = IHabboWindowManager(param2);
         if(this.var_1264)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_195)
            {
               if(this.var_195.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1537)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1157);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1157,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_214 = param2 as IHabboFriendList;
         Component(this.var_214).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_214).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_214).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_214).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_214).events.addEventListener(HabboFriendListTrackingEvent.const_405,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_780,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_316.events.addEventListener(AdEvent.const_590,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_188 = param2 as IHabboToolbar;
         this.var_188.events.addEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_676)
         {
            this.var_676.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_548 > -1 && _loc2_ < this.var_548)
         {
            ++this.var_1979;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1979);
         }
         if(this.var_548 > -1 && _loc2_ - this.var_548 > 15000)
         {
            ++this.var_1980;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1980);
         }
         this.var_548 = _loc2_;
         if(this.var_282 != null)
         {
            this.var_282.update(param1,this.var_548);
         }
         if(this.var_281 != null)
         {
            this.var_281.update(param1,this.var_548);
         }
         if(this.var_674 != null)
         {
            this.var_674.trackUpdate(param1,this,this.var_548);
         }
         if(this.var_675 != null)
         {
            this.var_675.update(this.var_548);
         }
      }
   }
}
