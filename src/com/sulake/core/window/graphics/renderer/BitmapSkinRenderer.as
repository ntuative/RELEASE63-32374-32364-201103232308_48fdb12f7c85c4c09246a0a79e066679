package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      private static var var_36:Rectangle = new Rectangle();
      
      private static const TOP_LEFT:Point = new Point();
       
      
      protected var var_849:Dictionary;
      
      protected var var_848:Dictionary;
      
      private var var_978:Matrix;
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc2_ = this.var_849[_loc1_] as BitmapData;
               _loc2_.dispose();
            ...
            {
               _loc2_ = this.var_848[_loc1_] as BitmapData;
               _loc2_.dispose();
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_467[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  _loc12_ = false;
                  _loc13_ = false;
                  var_36.x = _loc10_.region.x + param3.x;
                  var_36.y = _loc10_.region.y + param3.y;
                  var_36.width = _loc10_.region.width;
                  var_36.height = _loc10_.region.height;
                  if(_loc10_.scaleH == SkinLayoutEntity.const_300)
                  {
                     var_36.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_544)
                  {
                     _loc12_ = true;
                     var_36.right += _loc14_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_289)
                  {
                     _loc12_ = true;
                     var_36.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_300)
                  {
                     var_36.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_544)
                  {
                     _loc13_ = true;
                     var_36.bottom += _loc15_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_289)
                  {
                     _loc13_ = true;
                     var_36.bottom += _loc15_;
                     if(true)
                  ...
                  if(!_loc12_ && !_loc13_)
                  {
                     _loc6_.copyPixels(_loc17_,_loc17_.rect,var_36.topLeft,_loc18_,TOP_LEFT,true);
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_289 || _loc10_.scaleH == SkinLayoutEntity.const_289)
                  {
                     ...
                     _loc23_ = 0 % _loc19_;
                     _loc24_ = 0 % _loc20_;
                     _loc25_ = new Point(var_36.x,var_36.y);
                  ...
                  {
                     _loc6_.fillRect(var_36,_loc17_.getPixel(0,0) | _loc18_.getPixel32(0,0) & 4278190080);
                  }
                  else
                  {
                     this.var_978.a = 0 / _loc17_.width;
                     this.var_978.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_36.width,var_36.height,false);
                     _loc30_.draw(_loc17_,this.var_978);
                     _loc31_ = new BitmapData(var_36.width,var_36.height,true,0);
                     _loc31_.draw(_loc18_,this.var_978,null);
                     _loc6_.copyPixels(_loc30_,_loc30_.rect,var_36.topLeft,_loc31_,TOP_LEFT,true);
                     _loc31_.dispose();
                     _loc30_.dispose();
                  }
               }
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_300)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_300)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_849[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_848[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
