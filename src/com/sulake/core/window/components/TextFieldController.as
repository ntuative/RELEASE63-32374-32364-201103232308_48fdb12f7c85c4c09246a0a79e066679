package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1297:String = "";
      
      protected var var_1294:Boolean = false;
      
      protected var var_829:Boolean = false;
      ...
      {
         this.var_1297 = param1 == null ? "" : param1;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_522)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_829 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_343,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_675,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1622);
         _loc1_.push(this.var_1294 != PropertyDefaults.const_1073 ? new PropertyStruct(PropertyDefaults.const_802,this.var_1294,PropertyStruct.const_37,true) : PropertyDefaults.const_1563);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1236 ? new PropertyStruct(PropertyDefaults.const_676,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1559);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1228 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1609);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_802:
                  this.var_1294 = _loc2_.value as Boolean;
                  if(this.var_1294)
                  {
               ...
               case PropertyDefaults.const_676:
                  ...
                  break;
               case PropertyDefaults.const_675:
