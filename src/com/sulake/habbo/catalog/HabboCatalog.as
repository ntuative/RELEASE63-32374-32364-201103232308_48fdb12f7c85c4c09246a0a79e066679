package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_237:PurchaseConfirmationDialog;
      
      private var var_328:ChargeConfirmationDialog;
      ...
      private var var_2791:Boolean = true;
      
      private var var_2789:Boolean = true;
      
      private var var_2008:Boolean = false;
      
      private var var_2790:GiftWrappingConfiguration;
      
      private var var_1276:ClubGiftController;
      ...
      private var var_1277:IDragAndDropDoneReceiver;
      
      private var var_89:PlacedObjectPurchaseData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.SESSION_ENDED,this.onRoomSessionEvent);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_237 == null)
            {
               this.var_237 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_237.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
      ...
      {
         this.var_188 = param2 as IHabboToolbar;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_393.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_195.getKey("client.credits.embed.enabled","false") == "ParkBusCannotEnterMessageEvent";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_321.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_321.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_76)
         {
            _loc3_ = this.var_321.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_832.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_111.getActivityPointsForType(Purse.const_196)));
         var _loc1_:int = 0;
      ...
      {
         this.var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_829)
         {
            if(!this.var_321.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_188 != null && _loc2_)
         {
            this.var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
         ...
         this.setupInventoryForRecycler(this.var_94.active && this._mainContainer.visible);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_393 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_83:
               this.var_2008 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1276 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_393.buildCatalogIndex(_loc2_);
         if(this.var_833 && this.var_833 != "")
         {
            this.var_393.openPage(this.var_833);
            this.var_833 = "";
            this.var_1038 = -1;
         }
         else if(this.var_1038 > -1)
         {
            this.var_393.openPageById(this.var_1038,this.var_2009);
            this.var_1038 = -1;
            this.var_2009 = -1;
            this.var_833 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2791 && this.var_512 != null)
         {
            this.var_512.playSound(HabboSoundTypesEnum.const_1036);
         }
         this.var_2791 = false;
         if(this.var_328 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_71,this.var_111.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2789 && this.var_512 != null)
         {
            this.var_512.playSound(HabboSoundTypesEnum.const_1101);
         }
         this.var_2789 = false;
         if(this.var_328 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1276.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2790 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_237 != null)
         {
            this.var_237.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_328 == null)
         {
            this.var_328 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_328.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_832.remove(_loc2_.method_1);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_832.add(_loc2_.method_1,_loc3_.slice());
            this.var_329.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.method_1,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "ParkBusCannotEnterMessageEvent" == this.var_195.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         if(!this.var_195.keyExists("catalog.drag_and_drop") || this.var_195.getKey("catalog.drag_and_drop") != "ParkBusCannotEnterMessageEvent")
         {
            return;
         }
         if(!this.var_1255 || !this.var_1255.isRoomOwner)
         {
            return;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_1278 && param1.type == RoomEngineObjectEvent.const_167)
         {
            this.resetPlacedOfferData();
            if(this.var_1039 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_89 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1039);
            if(this.var_1277 != null)
            {
               this.var_1277.onDragAndDropDone(true);
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_1039.productContainer.firstProduct;
            if(_loc2_ == RoomObjectCategoryEnum.const_29)
            {
            ...
            if(_loc4_)
            {
               _loc4_.getModelController().setNumber(RoomObjectVariableEnum.const_282,0.5);
            }
            this.resetObjectMover();
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_89 != null)
         {
            if(this.var_89.category == RoomObjectCategoryEnum.const_29)
            {
               this._roomEngine.disposeObjectFurniture(this.var_89.roomId,this.var_89.roomCategory,this.var_89.objectId);
            }
            else if(this.var_89.category == RoomObjectCategoryEnum.const_26)
            {
               this._roomEngine.disposeObjectWallItem(this.var_89.roomId,this.var_89.roomCategory,this.var_89.objectId);
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_89.objectId,this.var_89.category);
            }
            this.var_89.dispose();
            this.var_89 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         if(this.var_89 && this.var_89.productClassId == param1.classId)
         {
            if(this.var_89.roomCategory == this._roomEngine.activeRoomCategory && this.var_89.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_89.category;
               _loc4_ = this.var_89.wallLocation;
               _loc5_ = this.var_89.x;
               _loc6_ = this.var_89.y;
               _loc7_ = this.var_89.direction;
