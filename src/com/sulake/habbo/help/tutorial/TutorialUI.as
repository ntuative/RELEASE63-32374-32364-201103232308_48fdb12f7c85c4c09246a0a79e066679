package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_290:String = "TUI_NAME_VIEW";
      
      public static const const_382:String = "TUI_CLOTHES_VIEW";
      
      public static const const_519:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_371:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_496,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_435,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_455,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_277,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1176 && this.var_1177 && this.var_1451;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_496,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_435,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_455,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_277,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_45 == null || this.var_45.id == const_92)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_496:
               this.var_1451 = true;
               if(this.var_45 != null && this.var_45.id == const_519)
               {
                  this.showView(const_92);
               }
               break;
            case HabboHelpTutorialEvent.const_435:
               if(this.var_45 != null && this.var_45.id == const_382)
               {
                  this.var_1841 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2581 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_290:
               ...
               if(this.var_371 == null)
               {
                  this.var_371 = new NameChangeView(this);
               }
               this.var_371.showMainView();
               this.prepareForTutorial();
               break;
            case const_382:
         ...
         this._window.height = _loc2_.height + this.var_2583;
         this._window.width = _loc2_.width + this.var_2581;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_45 != null && (this.var_45.id == const_290 || this.var_45.id == const_92))
         {
            this.showView(const_92);
         }
      }
      ...
      {
         this.var_1176 = true;
         if(this.var_45 != null && (this.var_45.id == const_382 || this.var_45.id == const_92))
         {
            this.showView(const_92);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_371.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_555)
         {
            this.var_371.checkedName = _loc2_.name;
         }
         else
         {
            this.var_371.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
