package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1394:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_608:DimmerViewColorGrid;
      
      private var var_430:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1302,const_1303,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_608 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_430 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1395 = _loc2_.light;
         if(this.var_430 != null)
         {
            this.var_430.setValue(this.var_1395);
         }
         this.var_541 = this.colors.indexOf(_loc2_.color);
         if(this.var_608 != null)
         {
            this.var_608.setSelectedColorIndex(this.var_541);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1394 = XML(_loc1_.content);
         return this.var_1394;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_430 != null)
         {
            this.var_430.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_608 != null)
         {
            this.var_608.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
