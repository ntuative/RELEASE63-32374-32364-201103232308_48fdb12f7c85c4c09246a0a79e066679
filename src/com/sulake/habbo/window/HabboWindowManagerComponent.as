package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_424:uint = 3;
      
      private static const const_1403:uint = 1;
      ...
      private var var_1007:IWindowRenderer;
      
      private var var_945:ISkinContainer;
      
      private var var_275:Array;
      
      private var var_1504:IEventDispatcher;
      
      private var var_1237:Boolean = false;
      
      private var var_1929:ProfilerOutput;
      
      private var var_1505:ProfilerAgentTask;
      
      private var var_1503:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_945 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_1007 = new WindowRenderer(this.var_945);
         this._windowContextArray = new Array(const_424);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_424)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_1007,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_266 = this._windowContextArray[const_1403];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1929)
            {
               this.var_1929 = new ProfilerOutput(context,this,this.var_1007);
            }
            this.var_1929.profiler = _loc3_;
            this.var_1505 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1505);
            this.var_1503 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1503);
            this.var_1237 = true;
         }
      }
      ...
      {
         return this.var_266.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_266.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_945.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_266.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1504.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_424 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1504.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_424)
         {
         ...
         this.var_1504.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1439,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1603,param2.name + ": " + param2.toString());
            }
         }
      }
