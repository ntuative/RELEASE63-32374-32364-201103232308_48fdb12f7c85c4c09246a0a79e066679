package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_331:int = 3;
      
      private static var var_1405:int = 2;
      ...
      private var var_1765:TriggerConfs;
      
      private var var_1767:ActionTypes;
      
      private var var_1766:ConditionTypes;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1130 = new SliderWindowController(this.var_83,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_83.assets,0,20,1);
         this.var_1130.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1130.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_738.hideAll(this.var_261);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_331)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_83.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_37.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_37 as TriggerDefinition != null)
         {
            this.var_83.send(new UpdateTriggerMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ActionDefinition != null)
         {
            this.var_83.send(new UpdateActionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ConditionDefinition != null)
         {
            this.var_83.send(new UpdateConditionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1130.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_132.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1405) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1405 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_83.send(new ApplySnapshotMessageComposer(this.var_37.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_331)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1765);
         this.refreshConfigureElement(this.var_1767);
         this.refreshConfigureElement(this.var_1766);
