package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function createHandlers() : void
      {
         ...
         this.var_79.push(new UserNotificationHandler(this._connection,this));
         this.var_79.push(new PetPackageHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         {
            this.gotoRoom(this.var_2701,this.var_2703,this.var_1942);
            this.var_1941 = false;
            this.var_1942 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_223,_loc7_));
         return true;
      }
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.SESSION_ENDED,_loc4_));
            _loc4_.dispose();
         }
      }
