package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1288:IWindowContainer;
      
      public static var var_1555:IWindowContainer;
      
      public static var var_2035:int = 6710886;
      ...
      private var var_493:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1110 = [];
         this.var_1384 = [AvatarEditorFigureCategory.const_912,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_221,AvatarEditorFigureCategory.const_745,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1288 == null)
         {
            ...
            var_1288 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1555 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1555 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_427 = new Timer(1000);
         this.var_427.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1384;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1384);
         }
         if(param1.length != this.var_1110.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2363 = this.canChangeOutfit();
            this.var_427.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_493 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_493.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_493.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1110.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_493.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_493.numSelectables)
               {
                  this.var_493.getSelectableAt(_loc6_).x = this.var_493.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1384;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_42) && (this.var_1726 == AvatarEditorSideCategory.const_105 || this.var_2362))
         {
      ...
      {
         if(this.var_1726 == AvatarEditorSideCategory.const_105)
         {
            this.var_2362 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_679:
               break;
            case AvatarEditorSideCategory.const_431:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_431);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_383 = param1;
         this.var_493.setSelected(this.var_493.getSelectableByName(param1));
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2364 = new Date().valueOf();
                  this.var_2363 = false;
                  this.var_427.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2364 > 5000;
      }
   }
}
