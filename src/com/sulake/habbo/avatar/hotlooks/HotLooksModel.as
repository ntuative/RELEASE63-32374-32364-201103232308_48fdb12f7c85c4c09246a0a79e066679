package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1801:String = "hot_looks";
      
      public static const const_1945:String = "my_looks";
      ...
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         ...
         this.var_486["null"] = new Array();
         this.var_486["null"] = new Array();
         this.var_486["undefined.index"] = 0;
         this.var_486["undefined.index"] = 0;
      ...
      override protected function init() : void
      {
         if(!var_16)
         {
            var_16 = new HotLooksView(this,controller.windowManager,controller.assets);
         }
         var_16.init();
         var_197 = true;
      }
      ...
      {
         var _loc2_:Array = this.var_486["null"];
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_486[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
