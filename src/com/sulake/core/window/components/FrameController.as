package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1330:String = "_TITLE";
      
      private static const const_1331:String = "_HEADER";
      
      private static const const_1333:String = "_CONTENT";
      
      private static const const_1332:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1410:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1330) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1410 = findChildByTag(const_1331) as IHeaderWindow;
            if(!this.var_1410)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_189 = findChildByTag(const_1333) as IWindowContainer;
            if(!this.var_189)
            {
      ...
      {
         return findChildByTag(const_1332) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1256,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1052 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_285,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_264,_loc3_.left,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_217,_loc3_.top,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_239,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_270,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         }
         else
         {
