package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_470:int = -1;
      
      protected var var_179:int = -1;
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_800.removeReference();
         }
         this.var_800 = param1;
         if(this.var_800 != null)
         {
            this.var_800.addReference();
         }
      }
      ...
      {
         this.var_470 = 4294967295;
         this.var_179 = 4294967295;
         this.var_103 = -1;
      }
