package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_175:IFrameWindow;
      
      private var var_677:IWindow;
      
      private var var_206:IBorderWindow;
      
      private var var_1138:TagListRenderer;
      
      private var var_143:IBorderWindow;
      
      private var var_2767:int;
      
      private const const_1007:int = 5;
      
      private const const_1788:int = 39;
      
      private const const_1786:int = 7829367;
      
      private const const_1787:int = 16777215;
      
      private const const_2072:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1138 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:* = [];
         this.var_69.groupListItemsWithTag("CMD_BUTTON",_loc3_,true);
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_206.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_206.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         {
            _loc7_ = 0;
            while(_loc7_ < this.var_69.numListItems)
            {
               _loc12_ = this.var_69.getListItemAt(_loc7_) as IRegionWindow;
               if(_loc12_ != null)
               {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_206.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_206.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1007;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc3_.textColor = this.const_1787;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_1007;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_355,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_355,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1138.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_69.getListItemByName(param1) as IRegionWindow;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this.var_69.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1156:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2767 > this.const_2072 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2767 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1786;
            if(_loc3_.length >= this.const_1788)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1788 - 1);
            }
         }
      }
      ...
      {
         this.var_175 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_175.center();
         this.var_175.procedure = this.badgesEventProc;
         this.var_175.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_175 && this.var_175.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_677 = null;
         var _loc2_:IItemGridWindow = this.var_175.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_175.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_175.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
