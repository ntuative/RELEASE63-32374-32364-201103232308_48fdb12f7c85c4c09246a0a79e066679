package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      private var var_705:ThumbListManager;
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         this.var_16 = IWindowContainer(_loc9_.buildFromXML(XML(_loc8_.content)));
         ...
         this.var_705 = new ThumbListManager(this._assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
         var _loc10_:IBitmapWrapperWindow = this.var_16.findChildByName("active_items_image") as IBitmapWrapperWindow;
         _loc10_.procedure = this.activeThumbListEventProc;
         var _loc11_:IBitmapWrapperWindow = this.var_16.findChildByName("inactive_items_image") as IBitmapWrapperWindow;
      ...
      {
         var _loc1_:IBitmapWrapperWindow = this.var_16.findChildByName("active_items_image") as IBitmapWrapperWindow;
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         var _loc1_:IBitmapWrapperWindow = this.var_16.findChildByName("inactive_items_image") as IBitmapWrapperWindow;
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function updateListViews() : void
      {
         ...
         this.var_705.updateImageFromList();
         this.var_704.updateImageFromList();
         var _loc1_:IBitmapWrapperWindow = this.var_16.findChildByName("inactive_items_image") as IBitmapWrapperWindow;
         var _loc2_:BitmapData = this.var_705.getListImage();
         _loc1_.bitmap = _loc2_;
         _loc1_.width = _loc2_.width;
         _loc1_.height = _loc2_.height;
         _loc1_.invalidate();
         var _loc3_:IBitmapWrapperWindow = this.var_16.findChildByName("active_items_image") as IBitmapWrapperWindow;
      ...
      public function updateActionView() : void
      {
         ...
         var _loc1_:IButtonWindow = this.var_16.findChildByName("activateEffect_button") as IButtonWindow;
         var _loc2_:ITextWindow = this.var_16.findChildByName("effectDescriptionText") as ITextWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function setEffectDescriptionImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_16.findChildByName("effectDescriptionImage") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function inactiveThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = new Point(WindowMouseEvent(param1).localX,WindowMouseEvent(param1).localY);
            _loc4_ = this.var_705.resolveIndexFromImageLocation(_loc3_);
