package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_685:Point;
      
      protected var var_1338:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_685);
         this._window.offset(this.var_685.x - this._offset.x,this.var_685.y - this._offset.y);
      }
