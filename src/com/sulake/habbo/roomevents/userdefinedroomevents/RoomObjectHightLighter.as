package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_83.roomEngine.getRoomObject(this.var_83.roomId,this.var_83.roomCategory,param1,RoomObjectCategoryEnum.const_29);
      }
