package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2075:int = 0;
      
      private const const_986:int = 1;
      
      private const const_1744:int = 2;
      
      private const const_1743:int = 3;
      
      private const const_1765:int = 42;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_512 = param6;
         this.var_512.events.addEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
         this.var_433 = new Map();
         this.var_433.add(FurniModel.const_45,new FurniGridView(this.var_68,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_433.add(FurniModel.const_51,new FurniGridView(this.var_68,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_512)
            {
               this.var_512.events.removeEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
               this.var_512 = null;
            }
            this.var_631 = null;
            this._disposed = true;
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_432);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_986;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1744;
         }
         else
         {
            _loc2_ = this.const_1743;
         }
         if(this.var_2146 == _loc2_)
         {
            return;
         }
         this.var_2146 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_986:
               ...
               break;
            case this.const_1744:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1743:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_45,FurniModel.const_51];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_432);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_386)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_362)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_398)
            {
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1058)
               {
                  _loc21_ = this.var_512.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_512.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_631.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1058)
               {
                  _loc22_ = this.var_512.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         else if(_loc3_ < this.const_1765)
         {
            _loc3_ = this.const_1765;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_61)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_411);
            }
         }
      }
      ...
      {
         if(this.var_631.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_631.indexOf(param1.id as Number) != -1)
            {
               this.var_631.splice(this.var_631.indexOf(param1.id as Number),1);
            }
         }
      }
   }
