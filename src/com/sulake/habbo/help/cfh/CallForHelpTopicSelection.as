package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_830 == null || _loc3_ < 0 || _loc3_ >= this.var_830.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_830[_loc3_];
            main.showUI(HabboHelpViewEnum.const_793);
            main.tellUI(HabboHelpViewEnum.const_793,null);
         }
      }
   }
}
