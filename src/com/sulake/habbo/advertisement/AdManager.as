package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1286:BitmapData = null;
      
      private var var_1284:BitmapData = null;
      ...
      {
         this.var_305 = param2 as IHabboCommunicationManager;
         if(this.var_305 == null)
         {
            return;
         }
         this._connection = this.var_305.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2816 = this._config.getKey("interstitial.enabled","false") == "ParkBusCannotEnterMessageEvent";
         this.var_2819 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2817 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2027 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_238 != null && this.var_238.running)
         {
            this.var_238.reset();
            return false;
         }
         ...
         if(this.var_2027 > 0 && this.var_2025 >= this.var_2027)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1285;
         if(_loc1_ > this.var_2819)
         {
            ++this.var_2025;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1554 = _loc2_.imageUrl;
         this.var_2818 = _loc2_.clickUrl;
         this.var_1285 = getTimer();
         if(this.var_1554 != "")
         {
            _loc3_ = this.var_1554;
            ...
            {
               this.var_238 = new Timer(this.var_2817,1);
               this.var_238.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_238.running)
            {
               this.var_238.reset();
            }
            this.var_238.start();
            _loc4_ = new URLRequest(this.var_1554);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_477,0,0,param1.bitmapData,this.var_2818));
            this.var_1285 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_583));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1553 = _loc2_.imageUrl;
         this.var_2026 = _loc2_.clickUrl;
         if(this.var_1553 != "" && this.var_2026 != "")
         {
            _loc3_ = this.var_1553;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1553);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_590,0,0,_loc4_,this.var_2026,this.var_1286,this.var_1284));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1286 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1284 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
