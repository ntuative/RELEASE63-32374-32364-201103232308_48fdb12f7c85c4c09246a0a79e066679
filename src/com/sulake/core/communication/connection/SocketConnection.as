package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1670:int = 10000;
      ...
      private var var_1116:IMessageClassManager;
      
      private var var_305:ICoreCommunicationManager;
      
      private var var_499:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_305 = param2;
         this.var_498 = new ByteArray();
         this.var_1116 = new MessageClassManager();
         this.var_82 = new Socket();
         this.var_358 = new Timer(const_1670,1);
         this.var_358.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_499)
         {
            this.var_499.connectionInit(param1,param2);
         }
      ...
      {
         this.var_305.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1116.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_734.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_499)
         {
            this.var_499.messageSent(String(_loc4_),_loc5_.toString());
         }
      ...
      {
         this.var_1116.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_734.getMessages(this.var_498,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_499)
               {
                  this.var_499.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1116.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_498,offset);
               this.var_498 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_498.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_498.writeByte(this.var_82.readUnsignedByte());
         }
      }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_358.delay + " ms). Possible Firewall.";
