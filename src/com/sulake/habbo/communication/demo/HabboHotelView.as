package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_803.loadAssetFromFile("hotel_view_banner_" + this.var_1241,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
