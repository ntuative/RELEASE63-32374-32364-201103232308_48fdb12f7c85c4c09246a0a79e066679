package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_199:Timer;
      
      protected var var_1338:uint = 0;
      
      protected var var_284:Function;
      
      protected var var_1301:int;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         {
            this._window = param1;
            this._window.addEventListener(WindowEvent.const_287,this.clientWindowDestroyed);
            this.var_284 = param2;
            this._working = true;
            this.var_1301 = param4;
            this.var_1302 = param5;
            this.var_199 = new Timer(40,0);
            this.var_199.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_199.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1301 *= 0.75;
         this.var_1302 *= 0.75;
         if(Math.abs(this.var_1301) <= 1 && Math.abs(this.var_1302) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_284 != null)
         {
            this.var_284(this.var_1301,this.var_1302);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_199.stop();
            this.var_199.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_199 = null;
         }
         if(this._working)
         {
            if(this._window == param1)
            {
               ...
               {
                  this._window.removeEventListener(WindowEvent.const_287,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
