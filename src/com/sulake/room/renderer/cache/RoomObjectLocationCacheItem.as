package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1592 || param1.getUpdateID() != this.var_2712)
         {
            this.var_2712 = param1.getUpdateID();
            if(param2.updateId != this.var_1592 || _loc4_.x != this.var_1247.x || _loc4_.y != this.var_1247.y || _loc4_.z != this.var_1247.z)
            {
               this.var_1592 = param2.updateId;
               this.var_1247.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2711 = _loc3_;
         if(_loc3_)
         {
