package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      protected var var_841:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_196:Shape;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_196)
            {
               this.var_196 = new Shape();
               this.var_196.visible = false;
               this.var_196.cacheAsBitmap = true;
               super.addChild(this.var_196);
            }
            this.var_196.graphics.clear();
            this.var_196.graphics.beginFill(255);
            this.var_196.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_196.graphics.endFill();
            this.getDisplayObject().mask = this.var_196;
         }
         else if(this.var_196)
         {
            super.removeChild(this.var_196);
            this.var_196.graphics.clear();
            this.var_196 = null;
         ...
         if(this.var_841)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2069,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2069,16777215);
                  }
                  var_335 += bitmap.width * bitmap.height * 4;
               }
