package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_55 == null)
         {
            this.var_55 = IWindowContainer(this._navigator.getXmlWindow(this.var_1048));
            this.var_55.visible = false;
            this.var_55.setParamFlag(HabboWindowParam.const_40,true);
         ...
         this.var_55.x = _loc2_.x + this.var_2350 + param1.width;
