package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_700)
         {
            this.var_700 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_700)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_699)
         {
            this.var_699 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_699)
            {
               return;
            }
