package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_16:HabboLoginDemoView;
      
      private var var_2542:PseudoRandom;
      ...
      private const const_1748:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_632 = param1;
            this.var_58.initConnection(HabboConnectionType.const_236);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.SESSION_ENDED,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_58 && this.var_166 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:String = this.var_166.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_166.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_227.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_166.getKey("use.sso.ticket") == "1";
         this.var_632 = this.var_166.getKey("sso.ticket",null);
         this.var_1823 = this.var_166.getKey("flash.client.url","");
         this.var_2541 = this.var_166.getKey("external.variables.txt","");
         if(this.var_227 == null)
         {
            this.var_227 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_58.mode = HabboConnectionType.const_88;
            if(this.var_632)
            {
               this.var_58.initConnection(HabboConnectionType.const_236);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               this.var_16 = new HabboLoginDemoView(this);
               this.var_16.addEventListener(HabboLoginDemoView.const_592,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_58.mode = HabboConnectionType.const_88;
            if(this.var_166.keyExists("local.environment"))
            {
               this.var_58.mode = HabboConnectionType.const_1041;
            }
         }
         this.var_58.initConnection(HabboConnectionType.const_236);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_807);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2542 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_58.mode)
         {
            case HabboConnectionType.const_88:
               _loc6_ = "";
               _loc6_ = this.var_166.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_166.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1440 = _loc4_;
               this.var_227.loadBannerImage(_loc7_ + "?token=" + this.var_1440,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1041:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1509:
               this.var_958 = this.generateRandomHexString(30);
               this.var_513 = new DiffieHellman(new BigInteger(this.var_166.getKey("connection.development.prime"),16),new BigInteger(this.var_166.getKey("connection.development.generator"),16));
               this.var_513.init(this.var_958);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2542);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1823,this.var_2541));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1748,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         else if(this.var_16 != null)
         {
            _loc5_ = this.var_16.name;
            _loc6_ = this.var_16.password;
      ...
      private function onIdentityAccounts(param1:IdentityAccountsEvent) : void
      {
         ...
         if(this.var_16)
         {
            this.var_16.populateUserList(param1.getParser().accounts);
         }
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2543)
         {
            _loc2_ = this.var_166.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2543 = true;
         var _loc2_:String = this.var_166.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_166.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1440);
