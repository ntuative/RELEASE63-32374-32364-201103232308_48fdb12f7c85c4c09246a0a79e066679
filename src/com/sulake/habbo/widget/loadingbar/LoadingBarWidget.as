package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_524:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_524.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_524 = null;
         }
         if(this.var_46 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_524 == null)
         {
            this.var_524 = new Sprite();
            this.var_524.addChild(new Bitmap(this.var_46));
            this.var_524.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_524.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_46;
            }
         }
         _loc2_.setDisplayObject(this.var_524);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1140 != "")
         {
            HabboWebTools.openWebPage(this.var_1140);
         }
      }
   }
}
