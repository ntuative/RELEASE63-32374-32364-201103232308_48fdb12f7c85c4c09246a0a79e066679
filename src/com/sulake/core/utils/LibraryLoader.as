package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1736:uint = 1;
      
      protected static const const_1737:uint = 2;
      
      protected static const const_1738:uint = 4;
      
      protected static const const_1739:uint = 3;
      
      protected static const name_3:uint = 7;
      
      public static const const_1583:int = 5;
      ...
      protected var var_1052:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1053:Boolean = false;
      
      protected var var_2849:String = "";
      
      protected var var_2850:String = "";
      ...
      protected var var_2921:uint = 0;
      
      protected var var_2851:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1120)
         {
            ...
            while(var_823.length < const_1553 && false)
            {
               _loc1_ = var_1030.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1052 ? uint(this.var_1308 - this.var_2087) : uint(getTimer() - this.var_2087);
      }
      ...
      {
         if(this.var_1053 && !_disposed)
         {
            this.var_1053 = false;
            if(!this.var_1052 && this.var_240)
            {
               this.var_1308 = -1;
               this.var_2087 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1052 && !_disposed && this.var_1307 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1583 - this.var_1307);
            if(this.var_2851)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_472 = LibraryLoader.name_3;
         ...
         if(this.var_472 == LibraryLoader.const_1739)
         {
         ...
         if(this.var_472 == LibraryLoader.name_3)
         {
