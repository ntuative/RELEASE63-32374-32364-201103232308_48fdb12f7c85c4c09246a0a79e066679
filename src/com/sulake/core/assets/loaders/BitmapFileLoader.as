package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1047 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1046 = new LoaderContext();
         this.var_1046.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1046);
         }
      }
      ...
      {
         this.var_1047 = param1.url;
         var_333 = 0;
         this.var_43.load(param1,this.var_1046);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_333 < var_2848)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1047 + (this.var_1047.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_333),this.var_1046);
               return true;
            }
         }
         return false;
