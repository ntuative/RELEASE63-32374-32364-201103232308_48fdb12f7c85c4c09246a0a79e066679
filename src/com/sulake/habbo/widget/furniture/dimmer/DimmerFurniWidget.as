package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_760,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_760,this.onHide);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         this.var_1150 = param1.selectedPresetId - 1;
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2457 = param1.presetId;
         this.var_1149 = param1.effectId;
         this._color = param1.color;
         this.var_1148 = param1.brightness;
         if(this.var_16 != null)
         {
            this.var_16.update();
         }
         if(!this.validateBrightness(this.var_1148,this.var_1149))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1148,this.var_1149 == 2);
      ...
      private function showInterface() : void
      {
         if(this.var_16 == null)
         {
            this.var_16 = new DimmerView(this);
         }
         if(this.var_16 != null)
         {
            this.var_16.showInterface();
         }
      }
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.var_1150 + 1;
         if(this._presets == null || _loc2_ < 0 || _loc2_ > this._presets.length)
         {
            return;
         }
         var _loc3_:int = this.var_16.selectedType;
         var _loc4_:uint = this.colors[this.var_16.selectedColorIndex];
         var _loc5_:int = this.var_16.selectedBrightness;
         var _loc6_:DimmerFurniWidgetPresetItem = this._presets[this.var_1150] as DimmerFurniWidgetPresetItem;
      ...
      public function previewCurrentSetting() : void
      {
         ...
         if(!this.validateBrightness(this.var_16.selectedBrightness,this.var_16.selectedType))
         {
            return;
         }
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this.colors[this.var_16.selectedColorIndex],this.var_16.selectedBrightness,this.var_16.selectedType == 2);
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1148,this.var_1149 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
