package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_934:uint = 8;
      
      private static const const_1273:String = "skin";
      
      private static const const_1275:String = "bitmap";
      
      private static const const_1272:String = "fill";
      
      private static const const_1274:String = "text";
      
      private static const const_1271:String = "label";
      
      private static const const_1270:String = "shape";
      ...
      private var var_2158:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1594 = new Dictionary();
         this.var_2157 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1594,this.var_2157);
         this.var_2156 = new Dictionary();
         this.var_2158 = new Dictionary();
         StateCodeTable.fillTables(this.var_2156,this.var_2158);
         this.var_408 = new Dictionary();
         this.var_408[const_1273] = BitmapSkinRenderer;
         this.var_408[const_1275] = BitmapDataRenderer;
         this.var_408[const_1272] = FillSkinRenderer;
         this.var_408[const_1274] = TextSkinRenderer;
         this.var_408[const_1271] = LabelRenderer;
         this.var_408[const_1270] = ShapeSkinRenderer;
         this.var_408[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_408[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_334 == null)
         {
            var_334 = new Array();
            var_334.push(WindowState.const_72);
            var_334.push(WindowState.const_82);
            var_334.push(WindowState.const_96);
            var_334.push(WindowState.const_54);
            var_334.push(WindowState.const_98);
            var_334.push(WindowState.const_81);
            var_334.push(WindowState.const_106);
            var_334.push(WindowState.const_99);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2829 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "ParkBusCannotEnterMessageEvent" : false;
                  ...
                  this.addSkinRenderer(this.var_1594[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_869[param1] == null)
         {
            this.var_869[param1] = new Array(const_934);
         }
         this.var_869[param1][param2] = param3;
         if(this.var_868[param1] == null)
         {
            this.var_868[param1] = new Array(const_934);
         }
         this.var_868[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_869[param1];
         if(_loc3_)
         {
